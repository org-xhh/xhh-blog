...
<span class="line"><span>}</span></span></code></pre></div><h2 id="defineasynccomponent" tabindex="-1">defineAsyncComponent <a class="header-anchor" href="#defineasynccomponent" aria-label="Permalink to &quot;defineAsyncComponent&quot;">​</a></h2><p>仅在路由匹配或交互触发时加载组件，避免加载未使用的组件资源。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// show 为 true 时才加载 AboutComp</span></span>
...
<span class="line"><span>  delay: 200,                         // 延迟200毫秒显示loading组件</span></span>
