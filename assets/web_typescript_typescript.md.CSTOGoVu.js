import{_ as l,D as i,c as o,I as n,w as p,a as s,a3 as e,j as t,o as c}from"./chunks/framework.C5U8cnJv.js";const x=JSON.parse('{"title":"typescript学习","description":"","frontmatter":{},"headers":[],"relativePath":"web/typescript/typescript.md","filePath":"web/typescript/typescript.md"}'),r={name:"web/typescript/typescript.md"},d=e(`<h1 id="typescript学习" tabindex="-1">typescript学习 <a class="header-anchor" href="#typescript学习" aria-label="Permalink to &quot;typescript学习&quot;">​</a></h1><p>TypeScript 是 JavaScript 的一个超集，扩展了 JavaScript 的语法。</p><h2 id="基本类型" tabindex="-1">基本类型 <a class="header-anchor" href="#基本类型" aria-label="Permalink to &quot;基本类型&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>let bool: boolean = false // 布尔值</span></span>
...
<span class="line"><span>}</span></span></code></pre></div>`,60),u=t("br",null,null,-1),h=t("br",null,null,-1),g=e(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 调用函数</span></span>
...
<span class="line"><span>console.log(transformer.transform(&quot;1.12&quot;)) // 输出：1.12</span></span></code></pre></div><h2 id="is" tabindex="-1">is <a class="header-anchor" href="#is" aria-label="Permalink to &quot;is&quot;">​</a></h2><p>is 关键字一般用于函数返回值类型中，判断参数是否属于某一类型，并根据结果返回对应的布尔类型。 语法：prop is type</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>function isString(s: unknown): boolean {</span></span>
