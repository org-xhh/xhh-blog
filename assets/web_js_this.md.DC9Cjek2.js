...
<span class="line"><span>hiFn()</span></span></code></pre></div><p>非严格模式：Hello,      (this 指向全局变量)</p>`,15),g=a(`<h2 id="显示绑定" tabindex="-1">显示绑定 <a class="header-anchor" href="#显示绑定" aria-label="Permalink to &quot;显示绑定&quot;">​</a></h2><ul><li>call <ul><li>.call(thisArg, arg1, arg2, ...)</li><li>立即调用函数</li><li>this 指向 thisArg</li><li>参数逐个传递</li></ul></li><li>apply <ul><li>.apply(thisArg, [arg1, arg2, ...])</li><li>立即调用函数</li><li>this 指向 thisArg</li><li>参数传递一个数组</li></ul></li><li>bind <ul><li>.bind(thisArg, arg1, arg2, ...)</li><li>不立即调用</li><li>返回一个this被永久绑定的新函数</li><li>也称“硬绑定”</li><li>可以预设部分参数（函数柯里化）</li></ul></li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>function introduce(age, city) {</span></span>
<span class="line"><span>  console.log(\`我是\${this.name}，\${age}岁，来自\${city}\`)</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span>const person1 = { name: &#39;小刘&#39; }</span></span>
<span class="line"><span>// bind 不执行，返回一个新函数</span></span>
<span class="line"><span>const fnn = introduce.bind(person1, 35) // 预设第一个参数 age=35</span></span>
<span class="line"><span>fnn(&#39;江苏&#39;)  // 我是小刘，35岁，来自江苏</span></span></code></pre></div><p><img src="`+r+`" alt="alt text"></p><h2 id="手写-apply" tabindex="-1">手写 apply <a class="header-anchor" href="#手写-apply" aria-label="Permalink to &quot;手写 apply&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Function.prototype.myApply = function(context, argsArray) {</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>  </span></span>
<span class="line"><span>  // 生成唯一属性名</span></span>
<span class="line"><span>  const fnKey = Symbol(&#39;fn&#39;)</span></span>
<span class="line"><span>  // this 就是调用 myApply 的那个函数</span></span>
...
<span class="line"><span>    console.log(++this.count)</span></span>
<span class="line"><span>}, 1000)</span></span></code></pre></div>`,25);function b(m,y,v,_,f,x){const n=e("font");return c(),l("div",null,[u,i("p",null,[s("严格模式："),t(n,{color:"red"},{default:o(()=>[s("Uncaught TypeError: Cannot read properties of undefined (reading 'name')")]),_:1})]),g])}const T=p(d,[["render",b]]);export{C as __pageData,T as default};
