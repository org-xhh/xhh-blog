...
<span class="line"><span>}</span></span></code></pre></div>`,90),u=t("br",null,null,-1),h=t("br",null,null,-1),g=e(`<h4 id="泛型类" tabindex="-1">泛型类 <a class="header-anchor" href="#泛型类" aria-label="Permalink to &quot;泛型类&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>class Goods&lt;T&gt; {</span></span>
...
<span class="line"><span>  return typeof s === &#39;string&#39;</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="内置的工具类型" tabindex="-1">内置的工具类型 <a class="header-anchor" href="#内置的工具类型" aria-label="Permalink to &quot;内置的工具类型&quot;">​</a></h2><p>‌Partial&lt;T&gt;：将类型T的所有属性变为可选</p><p>‌Required&lt;T&gt;：将类型T的所有属性变为必填</p><p>‌Pick&lt;T, K&gt;：从类型T中选择指定属性K来创建一个新类型</p><p>‌Omit&lt;T, K&gt;：从类型T中排除指定属性K来创建一个新类型</p><p>Uppercase&lt;T&gt;：将字符串T转换为大写</p><p>‌Lowercase&lt;T&gt;：将字符串T转换为小写</p><p>‌Capitalize&lt;T&gt;：将字符串T的首字母大写</p><p>‌Uncapitalize&lt;T&gt;：将字符串T的首字母小写</p><p>...</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>type T = &#39;hi&#39;</span></span>
...
<span class="line"><span>    // &quot;strictFunctionTypes&quot;: true,</span></span>
<span class="line"><span>    // &quot;strictBindCallApply&quot;: true,</span></span>
<span class="line"><span>    // &quot;strictPropertyInitialization&quot;: true,</span></span>
<span class="line"><span>    // &quot;noImplicitThis&quot;: true,</span></span>
<span class="line"><span>    // &quot;alwaysStrict&quot;: true</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p><a href="http://tslang.cn/play/index.html" target="_blank" rel="noreferrer">http://tslang.cn/play/index.html</a></p>`,65);function b(m,v,y,q,k,f){const a=i("font");return c(),o("div",null,[r,n(a,{color:"red"},{default:p(()=>[s("<T> ")]),_:1}),s(" 表示这是一个泛型函数；"),u,n(a,{color:"red"},{default:p(()=>[s("T")]),_:1}),s(" 是一个类型参数，可以是任何类型； "),h,s(" 函数参数是"),n(a,{color:"red"},{default:p(()=>[s("T")]),_:1}),s("，返回值的类型也是"),n(a,{color:"red"},{default:p(()=>[s("T")]),_:1}),s("；传参 number 类型，那返回值的类型也是 number。 "),g])}const T=l(d,[["render",b]]);export{x as __pageData,T as default};
