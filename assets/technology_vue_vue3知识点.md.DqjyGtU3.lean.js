...
<span class="line"><span>defineExpose({ keywords })</span></span></code></pre></div><p><img src="`+r+`" alt="alt text"></p><h2 id="组件-props-和-自定义事件" tabindex="-1">组件 props 和 自定义事件 <a class="header-anchor" href="#组件-props-和-自定义事件" aria-label="Permalink to &quot;组件 props 和 自定义事件&quot;">​</a></h2><p>父组件：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;template&gt;</span></span>
