...
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>export default Page2;</span></span></code></pre></div><h4 id="页面效果" tabindex="-1">页面效果 <a class="header-anchor" href="#页面效果" aria-label="Permalink to &quot;页面效果&quot;">​</a></h4><p><img src="`+u+`" alt="alt text"></p><p>备注：chrome 插件 - Redux DevTools</p><h4 id="在-store-中使用异步操作" tabindex="-1">在 store 中使用异步操作： <a class="header-anchor" href="#在-store-中使用异步操作" aria-label="Permalink to &quot;在 store 中使用异步操作：&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>export const counterSlice = createSlice({</span></span>
<span class="line"><span>  ...</span></span>
<span class="line"><span>  reducers: {</span></span>
<span class="line"><span>    ...</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>// 子组件必须进行memo优化，否则useCallback没有任何性能提升。</span></span></code></pre></div><h4 id="forwardref-高阶组件" tabindex="-1">forwardRef 高阶组件 <a class="header-anchor" href="#forwardref-高阶组件" aria-label="Permalink to &quot;forwardRef 高阶组件&quot;">​</a></h4><p>forwardRef 可以让子组件通过 ref 向父组件公开dom节点，父组件获取到子组件的dom，可以执行该dom节点的方法。</p><p>子组件：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { forwardRef } from &#39;react&#39;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>&lt;/div&gt;</span></span></code></pre></div><h3 id="第三方-hooks" tabindex="-1">第三方 hooks <a class="header-anchor" href="#第三方-hooks" aria-label="Permalink to &quot;第三方 hooks&quot;">​</a></h3><p><a href="https://ahooks.js.org/zh-CN" target="_blank" rel="noreferrer">https://ahooks.js.org/zh-CN</a></p><p><a href="https://github.com/streamich/react-use" target="_blank" rel="noreferrer">https://github.com/streamich/react-use</a></p><h2 id="api-use" tabindex="-1">API use <a class="header-anchor" href="#api-use" aria-label="Permalink to &quot;API use&quot;">​</a></h2><p>React19+，use 结合 &lt;Suspense&gt;，实现数据加载loading</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { Suspense, use } from &#39;react&#39;</span></span>
<span class="line"><span></span></span>
