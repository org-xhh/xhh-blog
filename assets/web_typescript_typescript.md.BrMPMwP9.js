...
<span class="line"><span>let text: undefined = undefined;</span></span></code></pre></div><h3 id="bigint" tabindex="-1">bigint <a class="header-anchor" href="#bigint" aria-label="Permalink to &quot;bigint&quot;">​</a></h3><h3 id="symbol" tabindex="-1">symbol <a class="header-anchor" href="#symbol" aria-label="Permalink to &quot;symbol&quot;">​</a></h3><h3 id="void" tabindex="-1">void <a class="header-anchor" href="#void" aria-label="Permalink to &quot;void&quot;">​</a></h3><p>函数没有有效返回值（可返回undefined和null）</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>function getName(name: string): void { // 空值</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 非空断言（!）</span></span>
<span class="line"><span>const user!: { name: string } // 强制认为非空（危险！）</span></span>
<span class="line"><span>const el = document.querySelector(&#39;.ele&#39;)!</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// const 断言（值不可变）</span></span>
<span class="line"><span>let arr = [1, 2] as const // 类型变为 readonly [1, 2]</span></span>
<span class="line"><span>arr.push(3) // 编译错误</span></span></code></pre></div><h2 id="接口" tabindex="-1">接口 <a class="header-anchor" href="#接口" aria-label="Permalink to &quot;接口&quot;">​</a></h2><p>描述对象的形状</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>interface Person {</span></span>
...
<span class="line"><span>MyNamespace.sayHello(); // Hello, TypeScript!</span></span></code></pre></div><h2 id="泛型" tabindex="-1">泛型 <a class="header-anchor" href="#泛型" aria-label="Permalink to &quot;泛型&quot;">​</a></h2><p>泛型（Generics）是允许同一个函数接受不同类型参数的一种模板；</p><p>泛型类似一个类型占位符，不直接指定具体的类型，使用尖括号 &lt;T&gt; 来表示。</p><h4 id="泛型函数" tabindex="-1">泛型函数 <a class="header-anchor" href="#泛型函数" aria-label="Permalink to &quot;泛型函数&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>function identity&lt;T&gt;(value: T): T {</span></span>
<span class="line"><span>  return value;</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,95),h=o("br",null,null,-1),g=e(`<h4 id="泛型类" tabindex="-1">泛型类 <a class="header-anchor" href="#泛型类" aria-label="Permalink to &quot;泛型类&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>class Goods&lt;T&gt; {</span></span>
...
<span class="line"><span>console.log(personName.sayHi())</span></span></code></pre></div><h4 id="泛型接口" tabindex="-1">泛型接口 <a class="header-anchor" href="#泛型接口" aria-label="Permalink to &quot;泛型接口&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>interface KeyValuePair&lt;K, V&gt; {</span></span>
<span class="line"><span>  key: K;</span></span>
<span class="line"><span>  value: V;</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span>let pair: KeyValuePair&lt;number, string&gt; = { key: 11, value: &#39;abc&#39; }</span></span></code></pre></div><p>下面代码定义了一个泛型接口 Transformer，它有两个类型参数 T 和 U，用于定义输入类型和输出类型：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>interface Transformer&lt;T, U&gt; {</span></span>
<span class="line"><span>  transform(input: T): U;</span></span>
<span class="line"><span>}</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>class typeTransformer implements Transformer&lt;string, number&gt; { // 类实现接口</span></span>
...
<span class="line"><span>console.log(getLength(obj)); // 报错 Argument of type &#39;null&#39; is not assignable to parameter of type &#39;HasLength&#39;.</span></span></code></pre></div><p>泛型约束 T extends HasLength 来限制泛型类型 T 必须满足 HasLength 接口的要求，即具有 length 属性。</p><h4 id="默认类型" tabindex="-1">默认类型 <a class="header-anchor" href="#默认类型" aria-label="Permalink to &quot;默认类型&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>interface Pagination&lt;T = string&gt; {</span></span>
<span class="line"><span>  data: T[];</span></span>
<span class="line"><span>  page: number;</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span>let pagination: Pagination = { data: [&#39;a&#39;, &#39;b&#39;], page: 1; } // T默认string</span></span></code></pre></div><h2 id="自定义类型守卫-is" tabindex="-1">自定义类型守卫 is <a class="header-anchor" href="#自定义类型守卫-is" aria-label="Permalink to &quot;自定义类型守卫 is&quot;">​</a></h2><p>is 关键字一般用于函数返回值类型中，判断参数是否属于某一类型，并根据结果返回对应的布尔类型。 语法：prop is type</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>function isString(s: unknown): boolean {</span></span>
...
<span class="line"><span>  return typeof s === &#39;string&#39;</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="内置工具类型" tabindex="-1">内置工具类型 <a class="header-anchor" href="#内置工具类型" aria-label="Permalink to &quot;内置工具类型&quot;">​</a></h2><p>‌Partial&lt;T&gt;：将类型T的所有属性变为可选</p><p>‌Required&lt;T&gt;：将类型T的所有属性变为必填</p><p>Readonly&lt;T&gt;：将类型T的所有属性变为只读</p><p>Uppercase&lt;T&gt;：将字符串T转换为大写</p><p>‌Lowercase&lt;T&gt;：将字符串T转换为小写</p><p>‌Capitalize&lt;T&gt;：将字符串T的首字母大写</p><p>‌Uncapitalize&lt;T&gt;：将字符串T的首字母小写</p><p>‌Pick&lt;T, K&gt;：从类型T中选择指定属性K来创建一个新类型</p><p>‌Omit&lt;T, K&gt;：从类型T中排除指定属性K来创建一个新类型</p><p>Record&lt;K, T&gt;：创建键为K类型，值为T类型的对象</p><p>...</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>type User = {</span></span>
<span class="line"><span>  id: number;</span></span>
<span class="line"><span>  name: string;</span></span>
<span class="line"><span>  email?: string;</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span>// 所有属性可选</span></span>
<span class="line"><span>type UserUpdate = Partial&lt;User&gt;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// 只选取 id 和 name</span></span>
<span class="line"><span>type UserObj = Pick&lt;User, &#39;id&#39; | &#39;name&#39;&gt;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// 排除 email 创建新类型</span></span>
<span class="line"><span>type UserData = Omit&lt;User, &#39;email&#39;&gt;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// 创建权限映射</span></span>
<span class="line"><span>type PermissionValue = &#39;read&#39; | &#39;write&#39; | &#39;admin&#39;</span></span>
<span class="line"><span>const permissions: Record&lt;PermissionValue, boolean&gt; = {</span></span>
<span class="line"><span>  read: true,</span></span>
<span class="line"><span>  write: false,</span></span>
<span class="line"><span>  admin: true</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="声明文件" tabindex="-1">声明文件 <a class="header-anchor" href="#声明文件" aria-label="Permalink to &quot;声明文件&quot;">​</a></h2><p>声明文件必需以 .d.ts 为后缀，用于描述已有 JavaScript 代码库的类型信息。</p><p>示例一：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>$(&#39;#foo&#39;)</span></span>
<span class="line"><span>// or</span></span>
<span class="line"><span>jQuery(&#39;#foo&#39;)</span></span></code></pre></div><p>在 ts 中，编译器并不知道 $ 或 jQuery 是什么</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>jQuery(&#39;#foo&#39;)</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>jQuery(&#39;#foo&#39;) // 不报错了</span></span></code></pre></div><p>示例二：</p><p>为‌没有类型定义的第三方库‌添加类型支持</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// src/@types/untyped-lib.d.ts</span></span>
<span class="line"><span>declare module &#39;untyped-lib&#39; {</span></span>
<span class="line"><span>  export function calculate(a: number, b: number): number;</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>确保 tsconfig.json 中的 include 包含该目录</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { calculate } from &#39;untyped-lib&#39;</span></span>
<span class="line"><span>const result = calculate(10, 20) // 不会报类型问题了</span></span></code></pre></div><h4 id="全局类型声明" tabindex="-1">全局类型声明 <a class="header-anchor" href="#全局类型声明" aria-label="Permalink to &quot;全局类型声明&quot;">​</a></h4><p>在window上使用一个未被声明的变量，会报错 <img src="`+d+`" alt="alt text"></p><p>解决办法：添加全局可访问的类型/变量</p><p>global.d.ts:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 扩展window接口</span></span>
<span class="line"><span>// 类型声明（不产生实际代码）</span></span>
<span class="line"><span>declare global {</span></span>
<span class="line"><span>  interface Window {</span></span>
<span class="line"><span>    currentUser: {</span></span>
<span class="line"><span>      name: string</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// 导出一个空对象，让文件成为模块</span></span>
<span class="line"><span>export {}</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 运行时赋值，产生实际代码</span></span>
<span class="line"><span>// 不再有报错提示</span></span>
<span class="line"><span>window.currentUser = { name: &#39;xhh&#39; }</span></span>
<span class="line"><span>console.log(window.currentUser.name)</span></span></code></pre></div><h4 id="三斜线指令" tabindex="-1">三斜线指令 <a class="header-anchor" href="#三斜线指令" aria-label="Permalink to &quot;三斜线指令&quot;">​</a></h4><ul><li>书写一个全局变量的声明文件:</li></ul><p>types/jquery-plugin/index.d.ts:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/// &lt;reference types=&quot;jquery&quot; /&gt;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>    &quot;skipLibCheck&quot;: true, // 跳过库类型检查，提升编译速度</span></span>
...
<span class="line"><span>  &quot;files&quot;:[&quot;a.ts&quot;,&quot;b.ts&quot;], // 显式列出参与类型的文件列表，优先级高于 include</span></span>
<span class="line"><span>  &quot;references&quot;: [] // 用于配置项目引用，管理 TypeScript 项目之间的依赖关系</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>新项目建议开启 strict</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>{</span></span>
<span class="line"><span>  &quot;compilerOptions&quot;: {</span></span>
<span class="line"><span>    &quot;strict&quot;: true,</span></span>
<span class="line"><span>    // 相当于同时开启：</span></span>
<span class="line"><span>    // &quot;noImplicitAny&quot;: true,</span></span>
<span class="line"><span>    // &quot;strictNullChecks&quot;: true, // 强制空值检查</span></span>
<span class="line"><span>    // &quot;strictFunctionTypes&quot;: true, // 函数参数逆变检查</span></span>
<span class="line"><span>    // &quot;strictBindCallApply&quot;: true, // 严格绑定函数参数</span></span>
<span class="line"><span>    // &quot;strictPropertyInitialization&quot;: true, // 类属性初始化检查</span></span>
<span class="line"><span>    // &quot;noImplicitThis&quot;: true,</span></span>
<span class="line"><span>    // &quot;alwaysStrict&quot;: true</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p><a href="http://tslang.cn/play/index.html" target="_blank" rel="noreferrer">http://tslang.cn/play/index.html</a></p>`,80);function b(m,v,y,k,q,f){const a=l("font");return c(),i("div",null,[u,n(a,{color:"red"},{default:p(()=>[s("T")]),_:1}),s(" 是一个类型参数，可以是任何类型；"),h,s(" 函数参数是"),n(a,{color:"red"},{default:p(()=>[s("T")]),_:1}),s("，返回值的类型也是"),n(a,{color:"red"},{default:p(()=>[s("T")]),_:1}),s("；传参 number 类型，那返回值的类型也是 number。 "),g])}const T=t(r,[["render",b]]);export{C as __pageData,T as default};
