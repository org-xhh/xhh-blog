...
<span class="line"><span>    { name: &quot;new name2&quot;, age: 21 }</span></span>
<span class="line"><span>  ]</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="torefs-toref-unref" tabindex="-1">toRefs, toRef, unref <a class="header-anchor" href="#torefs-toref-unref" aria-label="Permalink to &quot;toRefs, toRef, unref&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>let person = reactive({</span></span>
<span class="line"><span>  name: &#39;张三&#39;,</span></span>
<span class="line"><span>  age: 19</span></span>
<span class="line"><span>})</span></span>
<span class="line"><span>// 解构出来的name不是响应式的，因为响应式代理的是对象本身，解构赋值相当于把值 复制 出来了，脱离了响应式系统</span></span>
<span class="line"><span>let { name, age } = person</span></span>
<span class="line"><span>function changeName() {</span></span>
<span class="line"><span>  name += &#39;~&#39; // 页面不会更新</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>let name1 = unref(name)</span></span>
<span class="line"><span>setTimeout(() =&gt; {</span></span>
<span class="line"><span>  name1 = &#39;该变量失去响应式&#39;</span></span>
<span class="line"><span>}, 2000)</span></span></code></pre></div><h2 id="computed" tabindex="-1">computed <a class="header-anchor" href="#computed" aria-label="Permalink to &quot;computed&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>let num1 = ref(0)</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>优化：</p>`,42),x=a(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>let val3 = reactive({</span></span>
<span class="line"><span>  name: 0,</span></span>
<span class="line"><span>  age: 18,</span></span>
<span class="line"><span>  obj: {</span></span>
<span class="line"><span>    count: 1</span></span>
...
<span class="line"><span>    // 组件卸载 watchEffect 会自动停止</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>  // 清理函数：组件卸载或依赖变化时执行</span></span>
<span class="line"><span>  onInvalidate(() =&gt; {</span></span>
<span class="line"><span>    clearInterval(timer)</span></span>
<span class="line"><span>  })</span></span>
<span class="line"><span>})</span></span></code></pre></div><h2 id="v-memo" tabindex="-1">v-memo <a class="header-anchor" href="#v-memo" aria-label="Permalink to &quot;v-memo&quot;">​</a></h2><p>长列表或复杂组件，可以使用v-memo缓存渲染结果，仅当依赖数据变化时才重新渲染，减少 DOM 操作。</p><h2 id="标签-ref-属性" tabindex="-1">标签 ref 属性 <a class="header-anchor" href="#标签-ref-属性" aria-label="Permalink to &quot;标签 ref 属性&quot;">​</a></h2><p>用在 html 标签上：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;template&gt;</span></span>
...
<span class="line"><span>defineExpose({ keywords })</span></span></code></pre></div><p><img src="`+d+`" alt="alt text"></p><h2 id="组件-props-和-自定义事件" tabindex="-1">组件 props 和 自定义事件 <a class="header-anchor" href="#组件-props-和-自定义事件" aria-label="Permalink to &quot;组件 props 和 自定义事件&quot;">​</a></h2><p>父组件：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;template&gt;</span></span>
...
<span class="line"><span>console.log(x, x.a, x.list)</span></span></code></pre></div><p><img src="`+u+`" alt="alt text"></p><p>加上类型校验：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { type Persons } from &#39;@/types&#39;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>    },</span></span>
<span class="line"><span>  ],</span></span>
<span class="line"><span>})</span></span></code></pre></div><p>defineEmits 自定义事件（子传父）</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const emit = defineEmits([&#39;update:title&#39;, &#39;submit&#39;])</span></span>
<span class="line"><span></span></span>
<span class="line"><span>const handleClick = () =&gt; {</span></span>
<span class="line"><span>  emit(&#39;update:title&#39;, &#39;标题&#39;)</span></span>
<span class="line"><span>  emit(&#39;submit&#39;, { data: &#39;提交数据&#39; })</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>TypeScript 写法：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 方式1：数组声明</span></span>
<span class="line"><span>const emit = defineEmits&lt;{</span></span>
<span class="line"><span>  (e: &#39;update:title&#39;, value: string): void</span></span>
<span class="line"><span>  (e: &#39;submit&#39;, data: any): void</span></span>
<span class="line"><span>}&gt;()</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// 方式2：Vue 3.3+ 对象声明</span></span>
<span class="line"><span>const emit = defineEmits&lt;{</span></span>
<span class="line"><span>  &#39;update:title&#39;: [value: string]</span></span>
<span class="line"><span>  &#39;submit&#39;: [data: any]</span></span>
...
<span class="line"><span>      },</span></span>
<span class="line"><span>      component: () =&gt; import(&#39;../views/login&#39;) // import 路由懒加载</span></span>
<span class="line"><span>    },</span></span>
<span class="line"><span>    ...</span></span>
<span class="line"><span>  ],</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>console.log(&#39;route:&#39;, route)</span></span></code></pre></div><p><img src="`+h+'" alt="alt text"></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>console.log(&#39;router.currentRoute.value:&#39;, router.currentRoute.value)</span></span></code></pre></div><p><img src="'+g+`" alt="alt text"></p><h3 id="路由规则的-props-配置" tabindex="-1">路由规则的 props 配置 <a class="header-anchor" href="#路由规则的-props-配置" aria-label="Permalink to &quot;路由规则的 props 配置&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>{</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><h2 id="defineasynccomponent" tabindex="-1">defineAsyncComponent <a class="header-anchor" href="#defineasynccomponent" aria-label="Permalink to &quot;defineAsyncComponent&quot;">​</a></h2><p>仅在路由匹配或交互触发时加载组件，避免加载未使用的组件资源。</p><p>路由匹配：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const routes = [</span></span>
<span class="line"><span>  {</span></span>
<span class="line"><span>    path: &#39;/home&#39;,</span></span>
<span class="line"><span>    component: () =&gt; import(&#39;@/views/home&#39;)</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>]</span></span></code></pre></div><p>Vue Router的import()语法，底层就是用的defineAsyncComponent</p><p>交互触发：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// show 为 true 时才加载 AboutComp</span></span>
<span class="line"><span>&lt;AboutComp v-if=&quot;show&quot; /&gt;</span></span>
<span class="line"><span>const AboutComp = defineAsyncComponent(() =&gt; import(&#39;../About.vue&#39;))</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const MyComponentComp = defineAsyncComponent({</span></span>
<span class="line"><span>  loader: () =&gt; import(&#39;./MyComponent.vue&#39;),</span></span>
<span class="line"><span>  loadingComponent: LoadingComponent, // 加载中的组件</span></span>
<span class="line"><span>  errorComponent: ErrorComponent,     // 错误时的组件</span></span>
<span class="line"><span>  delay: 200,                         // 延迟200ms再显示loading组件</span></span>
<span class="line"><span>  timeout: 3000,                      // 超时时间</span></span>
<span class="line"><span>})</span></span></code></pre></div><h2 id="keep-alive" tabindex="-1">keep-alive <a class="header-anchor" href="#keep-alive" aria-label="Permalink to &quot;keep-alive&quot;">​</a></h2><p>keep-alive 缓存组件</p><p>场景：从首页 home 进入列表页 list，不需要缓存；从列表页进入详情页 detail，再从详情页返回到列表页，这时列表页需要使用上次缓存的内容不要刷新。</p><p>App.vue</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;script setup&gt;</span></span>
<span class="line"><span>import { watch, ref } from &#39;vue&#39;</span></span>
<span class="line"><span>import { useRoute } from &#39;vue-router&#39;</span></span>
<span class="line"><span>const route = useRoute()</span></span>
<span class="line"><span></span></span>
<span class="line"><span>let cachedComponents = ref([])</span></span>
<span class="line"><span>watch(route, (val) =&gt; {</span></span>
<span class="line"><span>    if (val.name === &#39;home&#39;) {</span></span>
<span class="line"><span>      cachedComponents.value = [&#39;&#39;]</span></span>
<span class="line"><span>    } else {</span></span>
<span class="line"><span>      cachedComponents.value = [&#39;list&#39;] // 组件的name</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>  }, { immediate: true }</span></span>
<span class="line"><span>)</span></span>
...
<span class="line"><span>    &lt;keep-alive :include=&quot;cachedComponents&quot;&gt;</span></span>
...
<span class="line"><span>&lt;/template&gt;</span></span></code></pre></div><p>list 页面生命周期：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { onMounted, onActivated, onDeactivated } from &#39;vue&#39;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>onMounted(() =&gt; {</span></span>
<span class="line"><span>  // 从首页进入 触发</span></span>
<span class="line"><span>  // 从详情页返回 不再触发，list被缓存，不走 mounted 了</span></span>
<span class="line"><span>  console.log(&#39;onMounted&#39;)</span></span>
<span class="line"><span>})</span></span>
<span class="line"><span>onActivated(() =&gt; {</span></span>
<span class="line"><span>  // 从首页进入 触发</span></span>
<span class="line"><span>  // 从详情页返回 触发</span></span>
<span class="line"><span>  console.log(&#39;active&#39;)</span></span>
<span class="line"><span>})</span></span>
<span class="line"><span>onDeactivated(() =&gt; {</span></span>
<span class="line"><span>  // 离开列表页 触发</span></span>
<span class="line"><span>  console.log(&#39;inactive&#39;)</span></span>
<span class="line"><span>})</span></span></code></pre></div><p>缓存的list页面保留上次滚动位置：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const router = createRouter({</span></span>
<span class="line"><span>  history: createWebHistory(import.meta.env.BASE_URL),</span></span>
<span class="line"><span>  routes: [...],</span></span>
<span class="line"><span>  scrollBehavior: (to, from) =&gt; {</span></span>
<span class="line"><span>    if (to.path !== &#39;/list&#39; || (to.path === &#39;/list&#39; &amp;&amp; from.path === &#39;/home&#39;)) {</span></span>
<span class="line"><span>      // 新开页面滚动条回到顶部</span></span>
<span class="line"><span>      return { top: 0 }</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>})</span></span></code></pre></div><p>vue2 keep-alive 配置：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;template&gt;</span></span>
<span class="line"><span>  &lt;div id=&quot;app&quot;&gt;</span></span>
<span class="line"><span>    &lt;keep-alive :include=&quot;cachedViews&quot;&gt;</span></span>
<span class="line"><span>      &lt;router-view /&gt;</span></span>
<span class="line"><span>    &lt;/keep-alive&gt;</span></span>
<span class="line"><span>  &lt;/div&gt;</span></span>
<span class="line"><span>&lt;/template&gt;</span></span>
...
<span class="line"><span>    return {</span></span>
<span class="line"><span>      cachedViews: [&#39;list&#39;]</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>  },</span></span>
<span class="line"><span>  watch: {</span></span>
...
<span class="line"><span>        if (val.name === &#39;home&#39;) {</span></span>
<span class="line"><span>          this.cachedViews = []</span></span>
<span class="line"><span>        } else {</span></span>
<span class="line"><span>          this.cachedViews = [&#39;list&#39;]</span></span>
<span class="line"><span>        }</span></span>
<span class="line"><span>      },</span></span>
<span class="line"><span>      immediate: true</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span>&lt;/script&gt;</span></span></code></pre></div><h2 id="pinia" tabindex="-1">pinia <a class="header-anchor" href="#pinia" aria-label="Permalink to &quot;pinia&quot;">​</a></h2><p>引入 pinia</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { createPinia } from &#39;pinia&#39;</span></span>
...
<span class="line"><span>    // 修改状态（支持同步/异步）</span></span>
...
<span class="line"><span>  },</span></span>
<span class="line"><span>})</span></span>
<span class="line"><span>&lt;/script&gt;</span></span></code></pre></div><p>或 Vue3.4+ defineModel 宏:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;template&gt;</span></span>
<span class="line"><span>  &lt;input v-model=&quot;modelValue&quot; /&gt;</span></span>
<span class="line"><span>&lt;/template&gt;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>&lt;script lang=&quot;ts&quot; setup&gt;</span></span>
<span class="line"><span>const modelValue = defineModel()</span></span>
<span class="line"><span>// defineModel() 返回的是 ref，会自动与父组件的 v-model 值保持同步</span></span>
<span class="line"><span>// modelValue.value = &quot;xxx&quot;</span></span>
...
<span class="line"><span>&lt;/script&gt;</span></span></code></pre></div><h2 id="插槽" tabindex="-1">插槽 <a class="header-anchor" href="#插槽" aria-label="Permalink to &quot;插槽&quot;">​</a></h2><h3 id="默认插槽" tabindex="-1">默认插槽 <a class="header-anchor" href="#默认插槽" aria-label="Permalink to &quot;默认插槽&quot;">​</a></h3><p>子组件：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;slot&gt;&lt;/slot&gt;</span></span>
<span class="line"><span>// 等同于</span></span>
<span class="line"><span>&lt;slot name=&quot;default&quot;&gt;&lt;/slot&gt;</span></span></code></pre></div><h3 id="具名插槽" tabindex="-1">具名插槽 <a class="header-anchor" href="#具名插槽" aria-label="Permalink to &quot;具名插槽&quot;">​</a></h3><p>子组件 Child.vue：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;div&gt;</span></span>
...
<span class="line"><span>&lt;/div&gt;</span></span></code></pre></div><p>父组件：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;Child&gt;</span></span>
...
<span class="line"><span>  &lt;/template&gt;</span></span>
<span class="line"><span>&lt;/Child&gt;</span></span></code></pre></div><p><img src="`+b+`" alt="alt text"></p><h3 id="作用域插槽" tabindex="-1">作用域插槽 <a class="header-anchor" href="#作用域插槽" aria-label="Permalink to &quot;作用域插槽&quot;">​</a></h3><p>子组件 Child.vue：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;slot :listP=&quot;list&quot;&gt;&lt;/slot&gt;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>import { reactive } from &#39;vue&#39;</span></span>
...
<span class="line"><span>  },</span></span>
<span class="line"><span>])</span></span></code></pre></div><p>父组件：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;Child&gt;</span></span>
...
<span class="line"><span>    &lt;/ol&gt;</span></span>
<span class="line"><span>  &lt;/template&gt;</span></span>
<span class="line"><span>&lt;/Child&gt;</span></span></code></pre></div><p><img src="`+k+`" alt="alt text"></p><p>和具名插槽结合在一起：</p><p>子组件：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;slot name=&quot;listcon&quot; :listP=&quot;list&quot;&gt;&lt;/slot&gt;</span></span></code></pre></div><p>父组件：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;template v-slot:listcon=&quot;{ listP }&quot;&gt;</span></span>
<span class="line"><span>// or</span></span>
<span class="line"><span>&lt;template #listcon=&quot;{ listP }&quot;&gt;</span></span></code></pre></div><h2 id="shallowref-shallowreactive" tabindex="-1">shallowRef, shallowReactive <a class="header-anchor" href="#shallowref-shallowreactive" aria-label="Permalink to &quot;shallowRef, shallowReactive&quot;">​</a></h2><p>浅代理，只代理对象属性，不代理对象属性的属性</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { shallowRef } from &#39;vue&#39;</span></span>
...
<span class="line"><span>})</span></span>
<span class="line"><span>function changeSum() { // 生效</span></span>
<span class="line"><span>  sum.value += 1</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span>function changePerson() { // 生效</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span>function changePersonName() { // 不生效</span></span>
...
<span class="line"><span>  },</span></span>
<span class="line"><span>})</span></span>
<span class="line"><span>function changePersonName() { // 生效</span></span>
<span class="line"><span>  person.name = &#39;ls&#39;</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span>function changePersonAge() { // 不生效</span></span>
<span class="line"><span>  person.inner.age += 1</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="triggerref" tabindex="-1">triggerRef <a class="header-anchor" href="#triggerref" aria-label="Permalink to &quot;triggerRef&quot;">​</a></h2><p>强制触发对 shallowRef 内层属性的响应</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { shallowRef, triggerRef } from &#39;vue&#39;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// 使用 shallowRef，只有 .value 是响应式的，内部不做深代理</span></span>
<span class="line"><span>const bigDeepData = shallowRef({</span></span>
<span class="line"><span>  list: Array(100).fill(null).map((_, i) =&gt; ({</span></span>
<span class="line"><span>    id: i,</span></span>
<span class="line"><span>    info: { detail: { deep: { num: i } } }</span></span>
<span class="line"><span>  }))</span></span>
<span class="line"><span>})</span></span>
<span class="line"><span></span></span>
<span class="line"><span>const updateDeep = () =&gt; {</span></span>
<span class="line"><span>  bigDeepData.value.list[0].info.detail.deep.num = 999999</span></span>
<span class="line"><span>  triggerRef(bigDeepData)  // 手动触发更新，强制刷新界面</span></span>
...
<span class="line"><span>  age: 18,</span></span>
<span class="line"><span>})</span></span>
<span class="line"><span>const person2 = reactive(person) // 不会成为响应式</span></span></code></pre></div><p><img src="`+A+`" alt="alt text"></p><p>使用场景: 为了防止误把第三方库变为响应式对象</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import mockjs from &#39;mockjs&#39;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>let mockJs = markRaw(mockjs)</span></span></code></pre></div><h2 id="customref" tabindex="-1">customRef <a class="header-anchor" href="#customref" aria-label="Permalink to &quot;customRef&quot;">​</a></h2><p>作用：创建一个自定义的 ref，并对其依赖项跟踪和更新触发进行逻辑控制。</p><p>自定义customRef实现防抖功能：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { customRef } from &#39;vue&#39;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>function debouncedRef(initialValue: string, delay: number = 300) {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>  })</span></span>
<span class="line"><span>}</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const msg = debouncedRef(&#39;&#39;, 500)</span></span></code></pre></div><h2 id="teleport" tabindex="-1">Teleport <a class="header-anchor" href="#teleport" aria-label="Permalink to &quot;Teleport&quot;">​</a></h2><p>需要将组件渲染到指定 DOM 节点，适用弹框、通知等场景。</p><p>父组件：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;div class=&quot;outer&quot;&gt;</span></span>
...
<span class="line"><span>    &lt;div v-if=&quot;isShow&quot; class=&quot;modal-mask&quot; @click=&quot;isShow = false&quot;&gt;</span></span>
<span class="line"><span>      &lt;div class=&quot;modal-content&quot; @click.stop&gt;</span></span>
<span class="line"><span>        &lt;div&gt;被渲染到body下，脱离父组件DOM&lt;/div&gt;</span></span>
<span class="line"><span>        &lt;button @click=&quot;isShow = false&quot;&gt;关闭弹框&lt;/button&gt;</span></span>
<span class="line"><span>      &lt;/div&gt;</span></span>
<span class="line"><span>    &lt;/div&gt;</span></span>
<span class="line"><span>  &lt;/Teleport&gt;</span></span>
<span class="line"><span>&lt;/template&gt;</span></span></code></pre></div><p><img src="`+q+`" alt="alt text"></p><h2 id="suspense" tabindex="-1">Suspense <a class="header-anchor" href="#suspense" aria-label="Permalink to &quot;Suspense&quot;">​</a></h2><p>具有异步功能的组件用 &lt;Suspense&gt; 包装。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;template&gt;</span></span>
<span class="line"><span>  &lt;div&gt;{{ str }}&lt;/div&gt;</span></span>
<span class="line"><span>&lt;/template&gt;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>&lt;script setup&gt;</span></span>
<span class="line"><span>import { ref } from &#39;vue&#39;</span></span>
<span class="line"><span>await new Promise((resolve) =&gt; setTimeout(() =&gt; {</span></span>
<span class="line"><span>  resolve()</span></span>
<span class="line"><span>}, 2000))</span></span>
<span class="line"><span>let str = ref(&#39;你好，异步组件&#39;)</span></span>
<span class="line"><span>&lt;/script&gt;</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;Suspense&gt;</span></span>
...
<span class="line"><span>    &lt;h3&gt;Loading...&lt;/h3&gt;</span></span>
<span class="line"><span>  &lt;/template&gt;</span></span>
<span class="line"><span>&lt;/Suspense&gt;</span></span></code></pre></div><p>2s的Loading，后显示组件</p><h2 id="样式穿透" tabindex="-1">样式穿透 <a class="header-anchor" href="#样式穿透" aria-label="Permalink to &quot;样式穿透&quot;">​</a></h2><table tabindex="0"><thead><tr><th>写法</th><th>适用版本</th><th>现状</th></tr></thead><tbody><tr><td>&gt;&gt;&gt;</td><td>Vue2（ Sass/Less 等预处理器不认 &gt;&gt;&gt;）</td><td>已废弃，不推荐</td></tr><tr><td>::v-deep</td><td>Vue2 + Vue3</td><td>过渡方案</td></tr><tr><td>:deep()</td><td>Vue3</td><td>官方推荐</td></tr></tbody></table><h2 id="全局-api-转移到应用对象" tabindex="-1">全局 API 转移到应用对象 <a class="header-anchor" href="#全局-api-转移到应用对象" aria-label="Permalink to &quot;全局 API 转移到应用对象&quot;">​</a></h2><ul><li>app.component</li><li>app.config</li><li>app.directive</li><li>app.mount</li><li>app.unmount</li><li>app.use</li></ul><h2 id="非兼容性改变" tabindex="-1">非兼容性改变 <a class="header-anchor" href="#非兼容性改变" aria-label="Permalink to &quot;非兼容性改变&quot;">​</a></h2><p><a href="https://v3-migration.vuejs.org/zh/breaking-changes/" target="_blank" rel="noreferrer">https://v3-migration.vuejs.org/zh/breaking-changes/</a></p><h2 id="百万级数据页面渲染优化" tabindex="-1">百万级数据页面渲染优化 <a class="header-anchor" href="#百万级数据页面渲染优化" aria-label="Permalink to &quot;百万级数据页面渲染优化&quot;">​</a></h2><p>1.Object.freeze() 冻结数据</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>this.bigDataList = Object.freeze(list)</span></span></code></pre></div><p>Vue无法对被冻结的数据进行响应式劫持，能直接省去海量监听对象的创建；</p><p>冻结后的数据无法修改，仅适用于纯展示类大数据列表，编辑类列表不适用。</p><p>2.虚拟列表</p><p>页面只渲染屏幕能看到的几十条DOM，滚动时动态替换可视区域数据，从根源减少DOM数量。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// listWraper 固定高度  @scroll</span></span>
<span class="line"><span>handleScroll() {</span></span>
<span class="line"><span>  const scrollTop = this.$refs.listWraper.scrollTop;</span></span>
<span class="line"><span>  const startIndex = Math.floor(scrollTop / this.itemHeight);</span></span>
<span class="line"><span>  const endIndex = startIndex + this.renderCount;</span></span>
<span class="line"><span>  // 更新可视区数据</span></span>
<span class="line"><span>  this.showList = this.bigDataList.slice(startIndex, endIndex);</span></span>
<span class="line"><span>  // 可视区列表偏移，实现滚动跟随</span></span>
<span class="line"><span>  this.transY = startIndex * this.itemHeight;</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>3.分片渲染 + 异步渲染(requestIdleCallback)</p><p>主线程一次只处理少量DOM渲染，利用浏览器空闲时间分片加载。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>renderChunkData() {</span></span>
<span class="line"><span>  return new Promise(resolve =&gt; {</span></span>
<span class="line"><span>    // requestIdleCallback 浏览器空闲时间渲染</span></span>
<span class="line"><span>    requestIdleCallback(() =&gt; {</span></span>
<span class="line"><span>      const chunkData = this.bigDataList.slice(this.currentIndex, this.currentIndex + this.pageSize)</span></span>
<span class="line"><span>      this.showList.push(...chunkData)</span></span>
<span class="line"><span>      this.currentIndex += this.pageSize</span></span>
<span class="line"><span>      // 递归分片渲染，直到全部加载完成</span></span>
<span class="line"><span>      if (this.currentIndex &lt; this.bigDataList.length) {</span></span>
<span class="line"><span>        this.renderChunkData()</span></span>
<span class="line"><span>      } else {</span></span>
<span class="line"><span>        resolve()</span></span>
<span class="line"><span>      }</span></span>
<span class="line"><span>    })</span></span>
<span class="line"><span>  })</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,182);function w(P,V,R,B,E,D){const n=e("font");return o(),l("div",null,[y,t("p",null,[s("就采用这种写法："),i(n,{color:"red"},{default:c(()=>[s("getter 函数并且加上 deep")]),_:1})]),x])}const M=p(C,[["render",w]]);export{j as __pageData,M as default};
