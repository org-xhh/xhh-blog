import{_ as a,c as s,o as n,a3 as e}from"./chunks/framework.C5U8cnJv.js";const g=JSON.parse('{"title":"javascript循环方法","description":"","frontmatter":{},"headers":[],"relativePath":"web/js/javascript循环方法.md","filePath":"web/js/javascript循环方法.md"}'),p={name:"web/js/javascript循环方法.md"},l=e(`<h1 id="javascript循环方法" tabindex="-1">javascript循环方法 <a class="header-anchor" href="#javascript循环方法" aria-label="Permalink to &quot;javascript循环方法&quot;">​</a></h1><h2 id="foreach" tabindex="-1">forEach() <a class="header-anchor" href="#foreach" aria-label="Permalink to &quot;forEach()&quot;">​</a></h2><ul><li><p>通常用于数组的迭代</p></li><li><p>处理引用类型的数组，forEach会改变原数组</p></li><li><p>不能使用break，continue，循环中途是无法停止的，总是会将所有成员遍历完</p></li></ul><h2 id="map" tabindex="-1">map() <a class="header-anchor" href="#map" aria-label="Permalink to &quot;map()&quot;">​</a></h2><ul><li><p>返回一个新数组(return)，其结果是该数组中的每个元素都调用一个提供的函数后返回的结果</p></li><li><p>支持链式调用</p></li><li><p>处理引用类型的数组，map会改变原数组</p></li><li><p>不能使用break，continue，循环中途是无法停止的，总是会将所有成员遍历完</p></li></ul><h2 id="for" tabindex="-1">for <a class="header-anchor" href="#for" aria-label="Permalink to &quot;for&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>for (let i = 0; i &lt; 10; i++) {</span></span>
...
<span class="line"><span>    ]</span></span>
<span class="line"><span>]</span></span></code></pre></div>`,53),i=[l];function t(o,c,r,d,h,u){return n(),s("div",null,i)}const v=a(p,[["render",t]]);export{g as __pageData,v as default};
