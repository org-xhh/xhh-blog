import{_ as s,c as a,o as n,a3 as p}from"./chunks/framework.C5U8cnJv.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"web/css/css样式集锦.md","filePath":"web/css/css样式集锦.md","lastUpdated":null}'),e={name:"web/css/css样式集锦.md"},l=p(`<h2 id="_0-5px-全边框" tabindex="-1">0.5px 全边框 <a class="header-anchor" href="#_0-5px-全边框" aria-label="Permalink to &quot;0.5px 全边框&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>li {</span></span>
