...
<span class="line"><span>}</span></span></code></pre></div><h2 id="defineasynccomponent" tabindex="-1">defineAsyncComponent <a class="header-anchor" href="#defineasynccomponent" aria-label="Permalink to &quot;defineAsyncComponent&quot;">​</a></h2><p>仅在路由匹配或交互触发时加载组件，避免加载未使用的组件资源。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 懒加载路由组件：仅当访问 /about 时才加载 About.vue</span></span>
<span class="line"><span>const About = defineAsyncComponent(() =&gt; import(&#39;../About.vue&#39;))</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const MyComponent = defineAsyncComponent({</span></span>
...
<span class="line"><span>  delay: 200,                        // 延迟显示加载组件，单位为毫秒</span></span>
<span class="line"><span>  timeout: 3000,                     // 超时时间，单位为毫秒</span></span>
