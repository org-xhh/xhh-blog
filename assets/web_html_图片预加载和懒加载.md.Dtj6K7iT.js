import{_ as n,c as s,o as a,a3 as p}from"./chunks/framework.C5U8cnJv.js";const h=JSON.parse('{"title":"Image 加载优化","description":"","frontmatter":{},"headers":[],"relativePath":"web/html/图片预加载和懒加载.md","filePath":"web/html/图片预加载和懒加载.md"}'),e={name:"web/html/图片预加载和懒加载.md"},t=p(`<h1 id="image-加载优化" tabindex="-1">Image 加载优化 <a class="header-anchor" href="#image-加载优化" aria-label="Permalink to &quot;Image 加载优化&quot;">​</a></h1><h2 id="图片预加载" tabindex="-1">图片预加载 <a class="header-anchor" href="#图片预加载" aria-label="Permalink to &quot;图片预加载&quot;">​</a></h2><p>图片预加载是指在页面加载时提前加载图片，使其缓存在浏览器中，当用户需要查看图片时立即显示，不需要等待加载。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>let image = new Image();</span></span>
