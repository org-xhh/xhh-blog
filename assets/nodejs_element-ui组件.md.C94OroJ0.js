import{_ as a,c as s,o as n,a3 as e}from"./chunks/framework.C5U8cnJv.js";const p="/xhh-blog/assets/%E7%BB%84%E4%BB%B6%E9%97%AE%E9%A2%98.DLOF3lEV.png",t="/xhh-blog/assets/clearable%E4%B9%8B%E5%90%8E.CJCFIDKA.png",_=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"nodejs/element-ui组件.md","filePath":"nodejs/element-ui组件.md"}'),l={name:"nodejs/element-ui组件.md"},i=e('<h3 id="el-table-fixed固定列-偶现样式问题的解决方案" tabindex="-1">el-table fixed固定列 偶现样式问题的解决方案 <a class="header-anchor" href="#el-table-fixed固定列-偶现样式问题的解决方案" aria-label="Permalink to &quot;el-table fixed固定列 偶现样式问题的解决方案&quot;">​</a></h3><p>如下图，“商品明细”下面有个横线 <img src="'+p+`" alt="alt text"> 问题原因： 代码里设置了：fixed=&quot;right&quot;，并且在非首次渲染table组件（数据是第一次加载table的时候获取的）会出现这种问题。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;el-table-column</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,11),c=[i];function o(d,r,h,u,g,b){return n(),s("div",null,c)}const m=a(l,[["render",o]]);export{_ as __pageData,m as default};
