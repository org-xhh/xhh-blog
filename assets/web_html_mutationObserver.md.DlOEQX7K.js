import{_ as s,c as n,o as a,a3 as e}from"./chunks/framework.C5U8cnJv.js";const v=JSON.parse('{"title":"MutationObserver","description":"","frontmatter":{},"headers":[],"relativePath":"web/html/mutationObserver.md","filePath":"web/html/mutationObserver.md"}'),t={name:"web/html/mutationObserver.md"},p=e(`<h1 id="mutationobserver" tabindex="-1">MutationObserver <a class="header-anchor" href="#mutationobserver" aria-label="Permalink to &quot;MutationObserver&quot;">​</a></h1><p>MutationObserver 是一个可以监听 DOM 结构变化的接口。当 DOM 对象树发生变动时，MutationObserver 会得到通知。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 需要观察的节点</span></span>
