...
<span class="line"><span>盒子height = 内容的高度</span></span></code></pre></div><p><img src="`+e+'" alt="alt text"></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>最终宽度：500 - 1(子元素padding)∗2 - 10(子元素border)∗2 = 478</span></span></code></pre></div><h3 id="四、css盒模型" tabindex="-1">四、CSS盒模型 <a class="header-anchor" href="#四、css盒模型" aria-label="Permalink to &quot;四、CSS盒模型&quot;">​</a></h3><ul><li><p>标准盒模型（content-box）</p><p>width只包含content，padding和border额外增加，这是浏览器的默认行为。</p></li><li><p>怪异盒模型（border-box）</p><p>width是content、padding和border的总和。设置的宽度width是最终占据的宽度（不含margin）。</p></li></ul><h3 id="五、结论" tabindex="-1">五、结论 <a class="header-anchor" href="#五、结论" aria-label="Permalink to &quot;五、结论&quot;">​</a></h3><ul><li>width:auto 是子元素的 content + padding + border + margin 撑满父元素的 content。</li><li>width:100% 是子元素的 content 撑满父元素的 content。</li><li>在开发中尽量选择设置 width: auto，避免子元素设置 padding、border、margin等导致子元素溢出父元素。</li><li>在开发中可以选择在根元素设置 box-sizing:border-box</li></ul>',23),o=[d];function h(r,g,b,u,m,x){return n(),a("div",null,o)}const w=s(c,[["render",h]]);export{_ as __pageData,w as default};
