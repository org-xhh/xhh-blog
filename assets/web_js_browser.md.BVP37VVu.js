...
<span class="line"><span>}</span></span></code></pre></div>`,6);function b(g,w,_,f,k,R){const s=i("font");return c(),o("div",null,[d,n(s,{color:"gray"},{default:e(()=>[h]),_:1}),u,n(s,{color:"gray"},{default:e(()=>[v]),_:1}),m])}const P=l(r,[["render",b]]);export{y as __pageData,P as default};
