...
<span class="line"><span>}</span></span></code></pre></div><h3 id="object" tabindex="-1">object <a class="header-anchor" href="#object" aria-label="Permalink to &quot;object&quot;">​</a></h3><p>Object 和 object 的区别：</p><ul><li><p>Object 广义对象（几乎囊括所有值，等同于any）</p></li><li><p>object 狭义对象（仅包含对象、数组、函数）</p></li></ul><p>{} 和 Object 的效果相同，相当于 new Object()</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>let a:Object = {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div>`,96),h=o("br",null,null,-1),g=e(`<h4 id="泛型类" tabindex="-1">泛型类 <a class="header-anchor" href="#泛型类" aria-label="Permalink to &quot;泛型类&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>class Goods&lt;T&gt; {</span></span>
...
<span class="line"><span>  return typeof s === &#39;string&#39;</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="内置工具类型" tabindex="-1">内置工具类型 <a class="header-anchor" href="#内置工具类型" aria-label="Permalink to &quot;内置工具类型&quot;">​</a></h2><p>‌Partial&lt;T&gt;：将类型T的所有属性变为可选</p><p>‌Required&lt;T&gt;：将类型T的所有属性变为必选</p><p>Readonly&lt;T&gt;：将类型T的所有属性变为只读</p><p>Uppercase&lt;T&gt;：将字符串T转换为大写</p><p>‌Lowercase&lt;T&gt;：将字符串T转换为小写</p><p>‌Capitalize&lt;T&gt;：将字符串T的首字母大写</p><p>‌Uncapitalize&lt;T&gt;：将字符串T的首字母小写</p><p>‌Pick&lt;T, K&gt;：从类型T中选择指定属性K来创建一个新类型</p><p>‌Omit&lt;T, K&gt;：从类型T中排除指定属性K来创建一个新类型</p><p>Record&lt;K, T&gt;：创建键为K类型，值为T类型的对象</p><p>...</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>type User = {</span></span>
<span class="line"><span>  id: number;</span></span>
<span class="line"><span>  name: string;</span></span>
