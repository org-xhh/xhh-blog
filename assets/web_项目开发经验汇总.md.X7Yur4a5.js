import{_ as a,c as s,o as n,a3 as p}from"./chunks/framework.C5U8cnJv.js";const e="/xhh-blog/assets/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%BC%BA%E7%BC%93%E5%AD%98.B0FQMlmC.png",l="/xhh-blog/assets/network206.DkQ3oLRl.png",i="/xhh-blog/assets/%E6%B8%B2%E6%9F%93%E7%A9%BA%E7%99%BD.yex4TdnC.jpg",t="/xhh-blog/assets/%E5%BE%AE%E4%BF%A1problem.BTvmTI2q.jpg",c="/xhh-blog/assets/%E5%BE%AE%E4%BF%A1%E6%8E%88%E6%9D%83%E9%97%AE%E9%A2%98.CGHMURu7.jpg",o="/xhh-blog/assets/%E5%BE%AE%E4%BF%A1%E6%8E%88%E6%9D%83%E9%97%AE%E9%A2%982.Dl1e_okA.jpg",r="/xhh-blog/assets/301.DdhEgxf1.jpg",d="/xhh-blog/assets/image.CK0Po21C.png",_=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"web/项目开发经验汇总.md","filePath":"web/项目开发经验汇总.md"}'),h={name:"web/项目开发经验汇总.md"},u=p('<h3 id="每次打开页面图片视频资源很耗流量-有没有办法解决" tabindex="-1">每次打开页面图片视频资源很耗流量，有没有办法解决？ <a class="header-anchor" href="#每次打开页面图片视频资源很耗流量-有没有办法解决" aria-label="Permalink to &quot;每次打开页面图片视频资源很耗流量，有没有办法解决？&quot;">​</a></h3><h4 id="图片" tabindex="-1">图片： <a class="header-anchor" href="#图片" aria-label="Permalink to &quot;图片：&quot;">​</a></h4><p>浏览器强缓存</p><p><img src="'+e+`" alt="alt text"></p><h4 id="视频" tabindex="-1">视频： <a class="header-anchor" href="#视频" aria-label="Permalink to &quot;视频：&quot;">​</a></h4><p>2.1 range请求头</p><p>Range: bytes=0-1024</p><p>如果服务器支持范围请求，它会以状态码206 Partial Content响应，并在消息体中包含指定范围的内容。</p><p>这种请求方式通常不支持强制缓存，因为Range请求的设计初衷是为了提高网络传输效率，允许客户端只加载视频的一部分，而不是整个视频文件。</p><p>2.2 完整文件请求</p><h3 id="前端获取当前时间-不同时区时间不一样如何统一" tabindex="-1">前端获取当前时间，不同时区时间不一样如何统一？ <a class="header-anchor" href="#前端获取当前时间-不同时区时间不一样如何统一" aria-label="Permalink to &quot;前端获取当前时间，不同时区时间不一样如何统一？&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>let moment = require(&#39;moment-timezone&#39;)</span></span>
...
<span class="line"><span>dayjs.tz(&quot;2025-01-15 14:25&quot;, &quot;Asia/Shanghai&quot;)</span></span></code></pre></div><h3 id="后台通过aes加密-前端通过aes解密-加密过后的特殊字符含有-号的无法正确解密" tabindex="-1">后台通过aes加密，前端通过aes解密，加密过后的特殊字符含有“+”号的无法正确解密？ <a class="header-anchor" href="#后台通过aes加密-前端通过aes解密-加密过后的特殊字符含有-号的无法正确解密" aria-label="Permalink to &quot;后台通过aes加密，前端通过aes解密，加密过后的特殊字符含有“+”号的无法正确解密？&quot;">​</a></h3><p>浏览器会把url中的+转为空格，导致解密失败。</p><p>解决办法：</p><p>第一种： 服务端把将“+”号转义为“%2B”，前端就可以把%2B解析为+了；</p><p>第二种： 使用base64编解码，不会出现+特殊字符。</p><h3 id="canvas-获取-video-视频第一帧做为封面图-偶现封面图加载不出来" tabindex="-1">canvas 获取 video 视频第一帧做为封面图，偶现封面图加载不出来? <a class="header-anchor" href="#canvas-获取-video-视频第一帧做为封面图-偶现封面图加载不出来" aria-label="Permalink to &quot;canvas 获取 video 视频第一帧做为封面图，偶现封面图加载不出来?&quot;">​</a></h3><p>代码如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const videoEle = document.createElement(&#39;video&#39;)</span></span>
...
<span class="line"><span>})</span></span></code></pre></div><p>退出微信h5页面到后台，暂停播放视频；再次打开页面，重新播放。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>document.addEventListener(&#39;visibilitychange&#39;, () =&gt; {</span></span>
<span class="line"><span>    if (document.visibilityState === &#39;visible&#39;) {</span></span>
<span class="line"><span>        // alert(&#39;play&#39;)</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>},</span></span></code></pre></div><h3 id="在子组件使用-van-popup-的-v-model-show-报不能修改父组件传来的show属性问题" tabindex="-1">在子组件使用 van-popup 的 v-model=&quot;show&quot; 报不能修改父组件传来的show属性问题 <a class="header-anchor" href="#在子组件使用-van-popup-的-v-model-show-报不能修改父组件传来的show属性问题" aria-label="Permalink to &quot;在子组件使用 van-popup 的 v-model=&quot;show&quot; 报不能修改父组件传来的show属性问题&quot;">​</a></h3><p><img src="`+d+`" alt="alt text"> 解决办法，定义一个新值：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;template&gt;</span></span>
<span class="line"><span>  &lt;van-popup</span></span>
<span class="line"><span>    v-model=&quot;isShow&quot;</span></span>
<span class="line"><span>    position=&quot;bottom&quot;</span></span>
<span class="line"><span>    safe-area-inset-bottom</span></span>
<span class="line"><span>    @click-overlay=&quot;clickCancel&quot;</span></span>
<span class="line"><span>  &gt;</span></span>
<span class="line"><span>    ...</span></span>
<span class="line"><span></span></span>
<span class="line"><span>data() {</span></span>
<span class="line"><span>    return {</span></span>
<span class="line"><span>      isShow: this.show</span></span>
<span class="line"><span>      ...</span></span>
<span class="line"><span></span></span>
<span class="line"><span>watch: {</span></span>
<span class="line"><span>    show(newVal, oldVal) {</span></span>
<span class="line"><span>        this.isShow = newVal</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h3 id="解决动画卡顿的问题" tabindex="-1">解决动画卡顿的问题 <a class="header-anchor" href="#解决动画卡顿的问题" aria-label="Permalink to &quot;解决动画卡顿的问题&quot;">​</a></h3><h4 id="requestanimationframe" tabindex="-1">requestAnimationFrame <a class="header-anchor" href="#requestanimationframe" aria-label="Permalink to &quot;requestAnimationFrame&quot;">​</a></h4><p>在浏览器下一次重绘（repaint）之前执行回调函数。</p><p>使用场景：如果长列表需要监听滚动事件，直接监听会导致事件高频触发，主线程被阻塞，滚动卡顿。</p><p>解决方法：用requestAnimationFrame包裹滚动事件的处理函数，让函数在浏览器下一次重绘前执行，避免频繁触发：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const handleScroll = () =&gt; {</span></span>
<span class="line"><span>  requestAnimationFrame(() =&gt; {</span></span>
<span class="line"><span>    const scrollTop = document.documentElement.scrollTop</span></span>
<span class="line"><span>    const clientHeight = document.documentElement.clientHeight</span></span>
<span class="line"><span>    const scrollHeight = document.documentElement.scrollHeight</span></span>
<span class="line"><span>    // 滚动到距离底部100px时，加载下一页</span></span>
<span class="line"><span>    if (scrollTop + clientHeight &gt;= scrollHeight - 100) {</span></span>
<span class="line"><span>      loadNextPage()</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>  })</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>window.addEventListener(&#39;scroll&#39;, handleScroll)</span></span></code></pre></div><p>补充：可以给滚动事件添加passive: true，提升滚动性能：</p><p>window.addEventListener(&#39;scroll&#39;, handleScroll, { passive: true })</p><h4 id="requestidlecallback" tabindex="-1">requestIdleCallback <a class="header-anchor" href="#requestidlecallback" aria-label="Permalink to &quot;requestIdleCallback&quot;">​</a></h4><p>在浏览器主线程的“空闲时期”执行低优先级的回调函数。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>let tasks = [task1, task2, task3, ...]</span></span>
<span class="line"><span></span></span>
<span class="line"><span>function processTasks(deadline) {</span></span>
<span class="line"><span>  // 浏览器空闲的时候就会执行，有空闲时间 deadline.timeRemaining() </span></span>
<span class="line"><span>  while (deadline.timeRemaining() &gt; 0 &amp;&amp; tasks.length &gt; 0) {</span></span>
<span class="line"><span>    let task = tasks.shift()</span></span>
<span class="line"><span>    execute(task)</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  // 还有任务没做完</span></span>
<span class="line"><span>  if (tasks.length &gt; 0) {</span></span>
<span class="line"><span>    requestIdleCallback(processTasks)</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>  let serverUrl = &#39;https://yourserver.com/logs&#39;</span></span>
<span class="line"><span>  const success = navigator.sendBeacon(serverUrl, data)</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>})</span></span></code></pre></div><p>pagehide 比 unload 更可靠，推荐使用 pagehide 代替 unload。</p>`,120),g=[u];function b(m,v,k,x,q,f){return n(),s("div",null,g)}const w=a(h,[["render",b]]);export{_ as __pageData,w as default};
