import{_ as l,D as i,c as o,I as n,w as e,a as s,a3 as p,j as t,o as c}from"./chunks/framework.C5U8cnJv.js";const C=JSON.parse('{"title":"typescript学习","description":"","frontmatter":{},"headers":[],"relativePath":"technology/react/typescript.md","filePath":"technology/react/typescript.md"}'),r={name:"technology/react/typescript.md"},u=p(`<h1 id="typescript学习" tabindex="-1">typescript学习 <a class="header-anchor" href="#typescript学习" aria-label="Permalink to &quot;typescript学习&quot;">​</a></h1><h2 id="基本类型" tabindex="-1">基本类型 <a class="header-anchor" href="#基本类型" aria-label="Permalink to &quot;基本类型&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>let bool: boolean = false // 布尔值</span></span>
...
<span class="line"><span>}</span></span></code></pre></div>`,45),d=t("br",null,null,-1),h=t("br",null,null,-1),g=p(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>identity&lt;number&gt;(10);</span></span>
...
<span class="line"><span>}</span></span></code></pre></div>`,54);function b(m,v,q,y,k,f){const a=i("font");return c(),o("div",null,[u,n(a,{color:"red"},{default:e(()=>[s("<T> ")]),_:1}),s(" 表示这是一个泛型函数；"),d,n(a,{color:"red"},{default:e(()=>[s("T")]),_:1}),s(" 是一个类型参数，可以是任何类型； "),h,s(" 函数参数是"),n(a,{color:"red"},{default:e(()=>[s("T")]),_:1}),s("，返回值的类型也是"),n(a,{color:"red"},{default:e(()=>[s("T")]),_:1}),s("。 "),g])}const T=l(r,[["render",b]]);export{C as __pageData,T as default};
