...
<span class="line"><span>    ]</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>])</span></span></code></pre></div><p><img src="`+r+`" alt="alt text"></p><h2 id="路由懒加载" tabindex="-1">路由懒加载 <a class="header-anchor" href="#路由懒加载" aria-label="Permalink to &quot;路由懒加载&quot;">​</a></h2><p>路由的JS资源只有在被访问时才会动态获取，目的是为了优化项目首屏时间。</p><ul><li>React 提供的 lazy 函数进行动态导入</li><li>Suspense 组件包裹element路由</li></ul><p>之前：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import Login from &#39;../pages/Login/login&#39;</span></span></code></pre></div><p>之后：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { Suspense, lazy } from &#39;react&#39;</span></span>
...
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// 在CSS Module中导出变量</span></span>
<span class="line"><span>:export {</span></span>
<span class="line"><span>  primaryColor: red;</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>2.引入样式 ‌</p><p>在组件文件中，使用 ES6 模块语法引入样式文件</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import styles from &#39;./styles.module.scss&#39;;</span></span></code></pre></div><p>‌3.使用样式 ‌</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;div className={styles[&#39;color-yellow&#39;]}&gt;</span></span>
<span class="line"><span>  &lt;span className={\`\${styles[&#39;sub-style&#39;]} flex\`}&gt;111&lt;/span&gt;</span></span>
<span class="line"><span>&lt;/div&gt;</span></span>
<span class="line"><span>&lt;span style={{ color: styles.primaryColor }}&gt;222&lt;/span&gt;</span></span></code></pre></div><h3 id="css-in-js-库-如styled-components" tabindex="-1">CSS-in-JS 库（如Styled Components） <a class="header-anchor" href="#css-in-js-库-如styled-components" aria-label="Permalink to &quot;CSS-in-JS 库（如Styled Components）&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import styled from &#39;styled-components&#39;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>const MyComponent = styled.div\`</span></span>
...
<span class="line"><span>&lt;/div&gt;</span></span></code></pre></div><h2 id="jsx" tabindex="-1">JSX <a class="header-anchor" href="#jsx" aria-label="Permalink to &quot;JSX&quot;">​</a></h2><p>JSX是Javascript和XML(HTML)的缩写，表示在JS代码中编写HTML模板结构。 是JS的语法扩展，浏览器本身不能识别，JSX 最终会被编译器（如 Babel）转换为 React.createElement() 调用。</p><p>通过大括号{}识别JavaScript中的表达式。</p><p>注意：if语句，switch语句，变量声明等属于语句，不是表达式，不能出现在{}中。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 组件（函数）首字母必须大写</span></span>
<span class="line"><span>function App() {</span></span>
<span class="line"><span>  let list = [</span></span>
<span class="line"><span>    {</span></span>
<span class="line"><span>      id: 1,</span></span>
<span class="line"><span>      title: &#39;xhh&#39;,</span></span>
...
<span class="line"><span>}, [dispatch])</span></span></code></pre></div><h3 id="zustand" tabindex="-1">zustand <a class="header-anchor" href="#zustand" aria-label="Permalink to &quot;zustand&quot;">​</a></h3><h4 id="安装-2" tabindex="-1">安装 <a class="header-anchor" href="#安装-2" aria-label="Permalink to &quot;安装&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>npm i zustand -S</span></span></code></pre></div><h4 id="创建-store" tabindex="-1">创建 store <a class="header-anchor" href="#创建-store" aria-label="Permalink to &quot;创建 store&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { create } from &#39;zustand&#39;</span></span>
<span class="line"><span>// zustand 核心API: create</span></span>
<span class="line"><span></span></span>
<span class="line"><span>const useCounterStore = create((set) =&gt; ({</span></span>
<span class="line"><span>  count: 0,</span></span>
<span class="line"><span>  increment: () =&gt; set((state) =&gt; ({ count: state.count + 1 })),</span></span>
<span class="line"><span>  decrement: () =&gt; set((state) =&gt; ({ count: state.count - 1 })),</span></span>
<span class="line"><span>  incrementByAmount: (amount) =&gt; set((state) =&gt; ({ count: state.count + amount }))</span></span>
<span class="line"><span>}))</span></span>
<span class="line"><span></span></span>
<span class="line"><span>export default useCounterStore</span></span></code></pre></div><p>zustand 是内存状态管理，负责驱动 UI 更新，页面刷新内存数据会丢失；借助 persist(&#39;zustand/middleware&#39;) 中间件搭配localStorage，页面刷新时自动读取本地数据恢复内存状态，实现状态持久保存。</p><h4 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import useCounterStore from &#39;@/store/counterStore&#39;</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>// 直接从 store 解析出需要的 state 和 action</span></span>
<span class="line"><span>const count = useCounterStore((state) =&gt; state.count)</span></span>
<span class="line"><span>const increment = useCounterStore((state) =&gt; state.increment)</span></span>
<span class="line"><span>const decrement = useCounterStore((state) =&gt; state.decrement)</span></span>
<span class="line"><span>const incrementByAmount = useCounterStore((state) =&gt; state.incrementByAmount)</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// 或者一次性获取所有（但不推荐，可能导致不必要的渲染）</span></span>
<span class="line"><span>// const { count, increment, decrement, incrementByAmount } = useCounterStore()</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>&lt;div&gt;{count}&lt;/div&gt;</span></span>
<span class="line"><span>&lt;div&gt;</span></span>
<span class="line"><span>  &lt;Button onClick={() =&gt; increment()}&gt;Increment&lt;/Button&gt;</span></span>
<span class="line"><span>  &lt;Button onClick={() =&gt; incrementByAmount(5)}&gt;Increment 5&lt;/Button&gt;</span></span>
<span class="line"><span>  &lt;Button onClick={decrement}&gt;Decrement&lt;/Button&gt;</span></span>
<span class="line"><span>&lt;/div&gt;</span></span></code></pre></div><p>备注：<code>useCounterStore.getState()</code> 返回<strong>整个 store 的全部内容（状态数据 + action 方法）</strong>，没有响应式，不会让组件更新。</p><h2 id="异步请求" tabindex="-1">异步请求 <a class="header-anchor" href="#异步请求" aria-label="Permalink to &quot;异步请求&quot;">​</a></h2><p>安装</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>npm i axios -S</span></span></code></pre></div><p>封装 utils/http.ts:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import axios from &#39;axios&#39;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// 仅导入类型，编译后移出，避免将类型信息打包进JS</span></span>
<span class="line"><span>import type { ResType } from &#39;./common.ts&#39;</span></span></code></pre></div><h2 id="受控组件" tabindex="-1">受控组件 <a class="header-anchor" href="#受控组件" aria-label="Permalink to &quot;受控组件&quot;">​</a></h2><p>受控组件：表单数据由组件状态（state）驱动</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const [text, setText] = useState(&#39;hello&#39;)</span></span>
...
<span class="line"><span>&lt;button onClick={() =&gt; console.log(text)}&gt;打印input值&lt;/button&gt;</span></span></code></pre></div><p>非受控组件：表单数据由 DOM 节点自身维护，使用 defaultValue 属性，非动态更新</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const inputRef = useRef(null)</span></span>
<span class="line"><span>const handleSubmit = (e) =&gt; {</span></span>
<span class="line"><span>  e.preventDefault()</span></span>
<span class="line"><span>  console.log(&#39;提交值:&#39;, inputRef.current.value)</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>return (</span></span>
...
<span class="line"><span>      defaultValue=&quot;这是初始值&quot; </span></span>
<span class="line"><span>      ref={inputRef} </span></span>
<span class="line"><span>    /&gt;</span></span>
<span class="line"><span>    &lt;button type=&quot;submit&quot;&gt;提交&lt;/button&gt;</span></span>
<span class="line"><span>  &lt;/form&gt;</span></span>
<span class="line"><span>)</span></span></code></pre></div><p>适用于：表单提交（只需要最终值）</p><h2 id="父子组件交互" tabindex="-1">父子组件交互 <a class="header-anchor" href="#父子组件交互" aria-label="Permalink to &quot;父子组件交互&quot;">​</a></h2><p>子组件只能读取 props 中的数据，不能直接修改，父组件的数据只能由父组件修改。</p><p>父组件：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import Button from &#39;../components/button&#39;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>function Page1() {</span></span>
...
<span class="line"><span>    })</span></span>
<span class="line"><span>  )</span></span>
<span class="line"><span>}</span></span></code></pre></div><h3 id="useeffect" tabindex="-1">useEffect <a class="header-anchor" href="#useeffect" aria-label="Permalink to &quot;useEffect&quot;">​</a></h3><p>在组件渲染到屏幕之后异步执行(dom可用)。这意味着它不会阻塞浏览器的绘制和更新，适用于大多数不会直接影响页面布局和视觉呈现的操作，用于执行副作用操作，如本地存储、ajax、操作DOM、计时器等‌。</p><p>副作用函数：指的是那些不直接属于“渲染 UI”的操作，在执行时会改变外部状态或依赖外部可变状态的函数。</p>`,72),C=l(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>useEffect(() =&gt; {</span></span>
<span class="line"><span>  window.addEventListener(&#39;resize&#39;, pageResizeFn)</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  // 清理函数</span></span>
<span class="line"><span>  return () =&gt; {</span></span>
<span class="line"><span>    window.removeEventListener(&#39;resize&#39;, pageResizeFn)</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}, [])</span></span></code></pre></div><ul><li>‌不传第二个参数‌：监测所有状态和属性，任何变化都会触发副作用函数：组件初始渲染+组件更新时执行</li><li>‌第二个参数为空数组‌（[]）：表示不监测任何依赖项，组件挂载时执行副作用函数，卸载时执行清除函数。</li><li>‌第二个参数为具体依赖项数组‌：组件初始渲染会执行；数组中的任意一个依赖项发生变化时，副作用函数也会执行，执行新的副作用之前会调用清除函数。</li></ul><h3 id="uselayouteffect‌" tabindex="-1">useLayoutEffect‌ <a class="header-anchor" href="#uselayouteffect‌" aria-label="Permalink to &quot;useLayoutEffect‌&quot;">​</a></h3><ul><li>在DOM更新完成后、浏览器绘制前‌同步执行‌，会阻塞浏览器的绘制过程</li><li>典型应用场景：动态调整元素尺寸/位置、避免UI闪烁等需要即时获取布局信息的操作</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import React, { useEffect, useLayoutEffect, useRef } from &#39;react&#39;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>export default Detail</span></span></code></pre></div><p>DOM 更新完毕后立刻调整位置，浏览器在绘制时就已经是最终位置，避免闪烁。</p><p>浏览器打开 url?top=10000会直接跳到该位置；如果用useEffect，会先在页面顶部，然后闪一下跳到10000位置。</p><h3 id="useref" tabindex="-1">useRef <a class="header-anchor" href="#useref" aria-label="Permalink to &quot;useRef&quot;">​</a></h3><p>访问 DOM 元素或保存不触发渲染的变量(不能作为hooks的依赖项，因为它不是一个响应式状态)</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const divRef = useRef(null);</span></span>
...
<span class="line"><span>  const value = useMemo(() =&gt; ({ theme, setTheme }), [theme])</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  return (</span></span>
...
<span class="line"><span>    &lt;/div&gt;</span></span>
<span class="line"><span>  );</span></span>
<span class="line"><span>};</span></span></code></pre></div><h4 id="use-context-selector-第三方库" tabindex="-1">use-context-selector 第三方库 <a class="header-anchor" href="#use-context-selector-第三方库" aria-label="Permalink to &quot;use-context-selector 第三方库&quot;">​</a></h4><p>核心 API：createContext/useContextSelector 可以用来创建 context 和从 context 中选取属性，如果这个属性没有发生变化则不会导致组件发生 re-render。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { createContext } from &#39;use-context-selector&#39;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>const UserContext = createContext({</span></span>
<span class="line"><span>  name: &#39;&#39;,</span></span>
<span class="line"><span>  age: 0</span></span>
<span class="line"><span>});</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { useContextSelector } from &#39;use-context-selector&#39;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>const UserProfile = () =&gt; {</span></span>
<span class="line"><span>  // 只订阅 name 字段，当 age 变化时，此组件不会重新渲染</span></span>
<span class="line"><span>  const userName = useContextSelector(UserContext, (state) =&gt; state.name)</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  return (</span></span>
<span class="line"><span>    &lt;div&gt;</span></span>
<span class="line"><span>      &lt;p&gt;用户名: {userName}&lt;/p&gt;</span></span>
<span class="line"><span>    &lt;/div&gt;</span></span>
<span class="line"><span>  )</span></span>
...
<span class="line"><span>    &lt;/&gt;</span></span>
<span class="line"><span>  )}</span></span></code></pre></div><h3 id="usememo" tabindex="-1">useMemo <a class="header-anchor" href="#usememo" aria-label="Permalink to &quot;useMemo&quot;">​</a></h3><p>缓存计算结果；依赖项变化时才重新计算，否则返回缓存值。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>  function fib(n) {</span></span>
...
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// 子组件必须进行memo优化，否则useMemo没有任何性能提升。</span></span></code></pre></div><h3 id="usecallback" tabindex="-1">useCallback <a class="header-anchor" href="#usecallback" aria-label="Permalink to &quot;useCallback&quot;">​</a></h3><p>缓存函数引用</p><p>之前：</p><p>父组件状态更新，onChange属性值handleChange会重新创建，导致子组件重新渲染。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { useCallback } from &quot;react&quot;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>// 子组件必须进行memo优化，否则useCallback没有任何性能提升。</span></span></code></pre></div><h4 id="forwardref-高阶组件" tabindex="-1">forwardRef 高阶组件 <a class="header-anchor" href="#forwardref-高阶组件" aria-label="Permalink to &quot;forwardRef 高阶组件&quot;">​</a></h4><p>forwardRef 可以让子组件通过 ref 向父组件公开dom节点，父组件获取到子组件的dom，可以执行该dom节点的方法；</p><p>React19+，不再强制使用forwardRef，ref可作为普通属性直接在函数组件中通过props.ref接收;</p><p>子组件：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { forwardRef } from &#39;react&#39;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// forwardRef&lt;T, P = {}&gt;()</span></span>
<span class="line"><span>// T‌：‌ref 所引用的目标类型‌（自定义接口 或 DOM 元素）‌</span></span>
<span class="line"><span>// P‌：‌组件 props 的类型‌，默认 {}</span></span>
<span class="line"><span>const Input = forwardRef&lt;HTMLInputElement&gt;((props, ref) =&gt; {</span></span>
...
<span class="line"><span>  customMethod: () =&gt; {...}</span></span>
...
<span class="line"><span>interface RefProps {</span></span>
<span class="line"><span>  focusHandler: () =&gt; void;</span></span>
<span class="line"><span>  testValue: number</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span>interface ChildProps {</span></span>
<span class="line"><span>  placeholder: string</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span>const MyInput = forwardRef&lt;RefProps, ChildProps&gt;((props, ref) =&gt; {</span></span>
...
<span class="line"><span>    focusHandler: () =&gt; {</span></span>
...
<span class="line"><span>    compRef.current.focusHandler();</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>const handleChange = (e) =&gt; {</span></span>
...
<span class="line"><span>    // 过渡更新: 低优先级，展示结果列表</span></span>
<span class="line"><span>    setResultList(e.target.value)</span></span>
<span class="line"><span>  });</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>return (</span></span>
<span class="line"><span>  &lt;&gt;</span></span>
<span class="line"><span>    &lt;input type=&quot;text&quot; value={inputValue} onChange={handleChange} /&gt;</span></span>
<span class="line"><span>    { isPending &amp;&amp; &lt;div&gt;Loading...&lt;/div&gt; }</span></span>
<span class="line"><span>  &lt;&gt;</span></span>
...
<span class="line"><span>// deferredValue === inputValue 执行某些操作，比如加载搜索列表</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>&lt;/div&gt;</span></span></code></pre></div><h3 id="第三方-hooks" tabindex="-1">第三方 hooks <a class="header-anchor" href="#第三方-hooks" aria-label="Permalink to &quot;第三方 hooks&quot;">​</a></h3><p><a href="https://ahooks.js.org/zh-CN" target="_blank" rel="noreferrer">https://ahooks.js.org/zh-CN</a></p><p><a href="https://github.com/streamich/react-use" target="_blank" rel="noreferrer">https://github.com/streamich/react-use</a></p><h2 id="api-use" tabindex="-1">API use <a class="header-anchor" href="#api-use" aria-label="Permalink to &quot;API use&quot;">​</a></h2><p>React19+，打破传统Hooks必须在顶层调用的限制，支持在条件、分支逻辑中直接读取Promise或Context；</p><p>use 结合 &lt;Suspense&gt;，实现数据加载loading：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { Suspense, use } from &#39;react&#39;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>const fetchMessage = () =&gt; {</span></span>
<span class="line"><span>  return new Promise((resolve) =&gt; {</span></span>
<span class="line"><span>    setTimeout(() =&gt; {</span></span>
<span class="line"><span>      resolve(&#39;hello world&#39;)</span></span>
<span class="line"><span>    }, 2000)</span></span>
<span class="line"><span>  })</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span>const Message = ({ messagePromise }) =&gt; {</span></span>
<span class="line"><span>  const message = use(messagePromise)</span></span>
<span class="line"><span>  return &lt;div&gt;{message}&lt;/div&gt;</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>const App = () =&gt; {</span></span>
<span class="line"><span>  const messagePromise = fetchMessage()</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  return (</span></span>
<span class="line"><span>    &lt;div&gt;</span></span>
<span class="line"><span>      &lt;Suspense fallback={&lt;div&gt;Loading...&lt;/div&gt;}&gt; </span></span>
<span class="line"><span>        &lt;Message messagePromise={messagePromise} /&gt;</span></span>
<span class="line"><span>      &lt;/Suspense&gt;</span></span>
<span class="line"><span>    &lt;/div&gt;</span></span>
<span class="line"><span>  )</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="虚拟列表" tabindex="-1">虚拟列表 <a class="header-anchor" href="#虚拟列表" aria-label="Permalink to &quot;虚拟列表&quot;">​</a></h2><p>react-window 或 react-virtualized</p><p>只渲染可视区域内的几十条</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { FixedSizeList as List } from &#39;react-window&#39;;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>function VirtualList({ items }) {</span></span>
<span class="line"><span>  const Row = ({ index, style }) =&gt; (</span></span>
<span class="line"><span>    &lt;div style={style}&gt;{items[index].name}&lt;/div&gt;</span></span>
<span class="line"><span>  );</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  return (</span></span>
<span class="line"><span>    &lt;List</span></span>
<span class="line"><span>      height={500}        // 容器高度</span></span>
<span class="line"><span>      itemCount={10000}   // 总条数</span></span>
<span class="line"><span>      itemSize={50}       // 每行高度</span></span>
<span class="line"><span>    &gt;</span></span>
<span class="line"><span>      {Row}</span></span>
<span class="line"><span>    &lt;/List&gt;</span></span>
<span class="line"><span>  );</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="ant-design" tabindex="-1">Ant Design <a class="header-anchor" href="#ant-design" aria-label="Permalink to &quot;Ant Design&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>npm install antd</span></span>
<span class="line"><span></span></span>
