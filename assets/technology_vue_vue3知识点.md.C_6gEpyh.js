...
<span class="line"><span>}</span></span></code></pre></div><p>优化：</p>`,40),x=a(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>let val3 = reactive({</span></span>
<span class="line"><span>  name: 0,</span></span>
<span class="line"><span>  age: 18,</span></span>
<span class="line"><span>  obj: {</span></span>
<span class="line"><span>    count: 1</span></span>
...
<span class="line"><span>defineExpose({ keywords })</span></span></code></pre></div><p><img src="`+d+`" alt="alt text"></p><h2 id="组件-props" tabindex="-1">组件 props <a class="header-anchor" href="#组件-props" aria-label="Permalink to &quot;组件 props&quot;">​</a></h2><p>父组件：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;template&gt;</span></span>
...
<span class="line"><span>    },</span></span>
<span class="line"><span>  ],</span></span>
<span class="line"><span>})</span></span></code></pre></div><p>defineEmits类型校验：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const emit = defineEmits&lt;{</span></span>
<span class="line"><span>  change: [id: number]</span></span>
<span class="line"><span>  update: [value: string]</span></span>
...
<span class="line"><span>// model.value = &quot;xxx&quot;</span></span>
...
<span class="line"><span>  &lt;/template&gt;</span></span>
<span class="line"><span>&lt;/Suspense&gt;</span></span></code></pre></div><p>2s的Loading，后显示组件</p><h2 id="样式穿透" tabindex="-1">样式穿透 <a class="header-anchor" href="#样式穿透" aria-label="Permalink to &quot;样式穿透&quot;">​</a></h2><table tabindex="0"><thead><tr><th>写法</th><th>适用版本</th><th>现状</th></tr></thead><tbody><tr><td>&gt;&gt;&gt;</td><td>Vue2（ Sass/Less 等预处理器不认 &gt;&gt;&gt;）</td><td>已废弃，不推荐</td></tr><tr><td>::v-deep</td><td>Vue2 + Vue3</td><td>过渡方案</td></tr><tr><td>:deep()</td><td>Vue3</td><td>官方推荐</td></tr></tbody></table><h2 id="全局-api-转移到应用对象" tabindex="-1">全局 API 转移到应用对象 <a class="header-anchor" href="#全局-api-转移到应用对象" aria-label="Permalink to &quot;全局 API 转移到应用对象&quot;">​</a></h2><ul><li>app.component</li><li>app.config</li><li>app.directive</li><li>app.mount</li><li>app.unmount</li><li>app.use</li></ul><h2 id="非兼容性改变" tabindex="-1">非兼容性改变 <a class="header-anchor" href="#非兼容性改变" aria-label="Permalink to &quot;非兼容性改变&quot;">​</a></h2><p><a href="https://v3-migration.vuejs.org/zh/breaking-changes/" target="_blank" rel="noreferrer">https://v3-migration.vuejs.org/zh/breaking-changes/</a></p>`,169);function w(P,V,R,B,E,D){const n=e("font");return o(),l("div",null,[y,t("p",null,[s("就采用这种写法："),i(n,{color:"red"},{default:c(()=>[s("getter 函数并且加上 deep")]),_:1})]),x])}const M=p(C,[["render",w]]);export{I as __pageData,M as default};
