...
<span class="line"><span>}</span></span></code></pre></div><p>将文件重命名为 .tsx 或 .ts 文件</p><hr><p>gitee 源码：</p><p><a href="https://gitee.com/org-xhh/react-project" target="_blank" rel="noreferrer">https://gitee.com/org-xhh/react-project</a></p>`,149),r=[o];function d(u,h,g,m,b,v){return n(),a("div",null,r)}const f=s(c,[["render",d]]);export{x as __pageData,f as default};
