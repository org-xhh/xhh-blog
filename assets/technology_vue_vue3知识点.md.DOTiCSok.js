...
<span class="line"><span>      cachedComponents.value = [&#39;list&#39;]</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>  }, { immediate: true }</span></span>
<span class="line"><span>)</span></span>
...
<span class="line"><span>  },</span></span>
<span class="line"><span>])</span></span></code></pre></div><p><img src="`+f+`" alt="alt text"></p><p>和具名插槽结合在一起</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;template v-slot:listcon=&quot;{ listP }&quot;&gt;</span></span>
<span class="line"><span>// or</span></span>
...
<span class="line"><span>const person2 = shallowReadonly(person)</span></span></code></pre></div><h2 id="toraw-markraw" tabindex="-1">toRaw, markRaw <a class="header-anchor" href="#toraw-markraw" aria-label="Permalink to &quot;toRaw, markRaw&quot;">​</a></h2><p>toRaw: 获取响应式对象的原始对象，返回的对象不再响应式</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>let newPerson = toRaw(person)</span></span></code></pre></div><p><img src="`+k+`" alt="alt text"></p><p>markRaw: 标记对象，使其永远不会成为响应式对象</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { reactive, markRaw } from &#39;vue&#39;</span></span>
...
<span class="line"><span>  &lt;/template&gt;</span></span>
<span class="line"><span>&lt;/Suspense&gt;</span></span></code></pre></div><p>2s的Loading，后显示组件</p><h2 id="样式穿透" tabindex="-1">样式穿透 <a class="header-anchor" href="#样式穿透" aria-label="Permalink to &quot;样式穿透&quot;">​</a></h2><table tabindex="0"><thead><tr><th>写法</th><th>适用版本</th><th>现状</th></tr></thead><tbody><tr><td>&gt;&gt;&gt;</td><td>Vue2（ Sass/Less 等预处理器不认 &gt;&gt;&gt;）</td><td>已废弃，不推荐</td></tr><tr><td>::v-deep</td><td>Vue2 + Vue3</td><td>过渡方案</td></tr><tr><td>:deep()</td><td>Vue3</td><td>官方推荐</td></tr></tbody></table><h2 id="全局-api-转移到应用对象" tabindex="-1">全局 API 转移到应用对象 <a class="header-anchor" href="#全局-api-转移到应用对象" aria-label="Permalink to &quot;全局 API 转移到应用对象&quot;">​</a></h2><ul><li>app.component</li><li>app.config</li><li>app.directive</li><li>app.mount</li><li>app.unmount</li><li>app.use</li></ul><h2 id="非兼容性改变" tabindex="-1">非兼容性改变 <a class="header-anchor" href="#非兼容性改变" aria-label="Permalink to &quot;非兼容性改变&quot;">​</a></h2><p><a href="https://v3-migration.vuejs.org/zh/breaking-changes/" target="_blank" rel="noreferrer">https://v3-migration.vuejs.org/zh/breaking-changes/</a></p>`,163);function w(P,V,R,B,E,D){const n=e("font");return o(),l("div",null,[C,t("p",null,[s("就采用这种写法："),i(n,{color:"red"},{default:c(()=>[s("getter 函数并且加上 deep")]),_:1})]),x])}const I=p(y,[["render",w]]);export{M as __pageData,I as default};
