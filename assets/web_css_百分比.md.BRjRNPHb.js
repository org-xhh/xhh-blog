...
<span class="line"><span>}</span></span></code></pre></div><h3 id="translate-转换" tabindex="-1">translate 转换 <a class="header-anchor" href="#translate-转换" aria-label="Permalink to &quot;translate 转换&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>div {</span></span>
<span class="line"><span>  transform: translate(50%, 100%); /* 元素沿X轴移动自身宽度的50%，沿Y轴移动自身高度的100% */</span></span>
<span class="line"><span>}</span></span></code></pre></div><h3 id="背景图片位置" tabindex="-1">背景图片位置 <a class="header-anchor" href="#背景图片位置" aria-label="Permalink to &quot;背景图片位置&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>div {</span></span>
<span class="line"><span>  background-image: url(&#39;image.jpg&#39;);</span></span>
<span class="line"><span>  background-repeat: no-repeat;</span></span>
<span class="line"><span>  background-position: 50% 50%; /* 水平方向是容器宽度的50%，垂直方向是容器高度的50% */</span></span>
<span class="line"><span>  /* 这种情况同 center，背景图片在容器内水平垂直居中 */</span></span>
<span class="line"><span>}</span></span></code></pre></div><h3 id="字体大小" tabindex="-1">字体大小 <a class="header-anchor" href="#字体大小" aria-label="Permalink to &quot;字体大小&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>div {</span></span>
<span class="line"><span>  font-size: 200%; /* 相对于父元素（或默认字体）大小的2倍 */</span></span>
