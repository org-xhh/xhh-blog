import{_ as n,c as s,o as a,a3 as p}from"./chunks/framework.C5U8cnJv.js";const h=JSON.parse('{"title":"vue2 指令","description":"","frontmatter":{},"headers":[],"relativePath":"technology/vue/vue指令.md","filePath":"technology/vue/vue指令.md"}'),e={name:"technology/vue/vue指令.md"},l=p(`<h1 id="vue2-指令" tabindex="-1">vue2 指令 <a class="header-anchor" href="#vue2-指令" aria-label="Permalink to &quot;vue2 指令&quot;">​</a></h1><h3 id="只能输入0和整数-输入中文问题" tabindex="-1">只能输入0和整数(输入中文问题) <a class="header-anchor" href="#只能输入0和整数-输入中文问题" aria-label="Permalink to &quot;只能输入0和整数(输入中文问题)&quot;">​</a></h3><p>v-integer0number：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>function integer0NumberFn(el) {</span></span>
