...
<span class="line"><span>  &quot;editor.formatOnSave&quot;: false</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="安装模块" tabindex="-1">安装模块 <a class="header-anchor" href="#安装模块" aria-label="Permalink to &quot;安装模块&quot;">​</a></h2><p><img src="`+t+'" alt="alt text"></p><hr><p>参考文档：</p><p><a href="https://www.tkcnn.com/eslint/rules.html" target="_blank" rel="noreferrer">https://www.tkcnn.com/eslint/rules.html</a></p><p><a href="https://prettier.io/docs/options" target="_blank" rel="noreferrer">https://prettier.io/docs/options</a></p>',34),l=[i];function o(r,c,d,u,h,g){return n(),a("div",null,l)}const v=s(p,[["render",o]]);export{b as __pageData,v as default};
