...
<span class="line"><span>    }</span></span>
<span class="line"><span>},</span></span></code></pre></div><h3 id="在子组件使用-van-popup-的-v-model-show-报不能修改父组件传来的show属性问题" tabindex="-1">在子组件使用 van-popup 的 v-model=&quot;show&quot; 报不能修改父组件传来的show属性问题 <a class="header-anchor" href="#在子组件使用-van-popup-的-v-model-show-报不能修改父组件传来的show属性问题" aria-label="Permalink to &quot;在子组件使用 van-popup 的 v-model=&quot;show&quot; 报不能修改父组件传来的show属性问题&quot;">​</a></h3><p><img src="`+h+`" alt="alt text"> 解决办法，定义一个新值：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;template&gt;</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h3 id="解决动画卡顿的问题" tabindex="-1">解决动画卡顿的问题 <a class="header-anchor" href="#解决动画卡顿的问题" aria-label="Permalink to &quot;解决动画卡顿的问题&quot;">​</a></h3><h4 id="requestanimationframe" tabindex="-1">requestAnimationFrame <a class="header-anchor" href="#requestanimationframe" aria-label="Permalink to &quot;requestAnimationFrame&quot;">​</a></h4><p>在浏览器下一次重绘（repaint）之前执行回调函数。</p><p>解决了视觉任务的调度问题，但如果有一个耗时较长的任务仍然会阻塞，导致卡顿。</p><h4 id="requestidlecallback" tabindex="-1">requestIdleCallback <a class="header-anchor" href="#requestidlecallback" aria-label="Permalink to &quot;requestIdleCallback&quot;">​</a></h4><p>在浏览器主线程的“空闲时期”执行低优先级的回调函数。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>let tasks = [task1, task2, task3, ...]</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>})</span></span></code></pre></div><p>pagehide 比 unload 更可靠，推荐使用 pagehide 代替 unload。</p>`,116),g=[u];function b(m,v,k,f,q,x){return n(),s("div",null,g)}const w=a(d,[["render",b]]);export{_ as __pageData,w as default};
