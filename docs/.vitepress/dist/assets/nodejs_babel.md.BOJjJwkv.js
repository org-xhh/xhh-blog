...
<span class="line"><span>obj?.foo?.xxx</span></span></code></pre></div>`,1),x=s("strong",null,"?.",-1),y=s("li",null,"获取项目中 @vue/babel-preset-app 版本，以此获取其依赖项 @babel/preset-env 版本",-1),C=s("li",null,"根据 @babel/preset-env 版本，确定是否包含 ES2020 特性",-1),T=s("li",null,"如果已包含，则项目中配置该预设就可以使用",-1),S=s("li",null,[a("如果不包含，则需要安装对应 "),s("a",{href:"https://babeljs.io/docs/plugins-list",target:"_blank",rel:"noreferrer"},"plugin")],-1),q=l(`<p>安装插件：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>npm install @babel/plugin-proposal-optional-chaining --save-dev</span></span></code></pre></div><p><strong>babel.config.js</strong>:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>module.exports = {</span></span>
<span class="line"><span>  presets: [</span></span>
<span class="line"><span>    &#39;@vue/app&#39;</span></span>
<span class="line"><span>  ],</span></span>
