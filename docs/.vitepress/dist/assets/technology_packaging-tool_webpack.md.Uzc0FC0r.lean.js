...
<span class="line"><span>    }</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>这样体积较大的 vendors 文件就被拆分为几个小的 vendors 文件。</p>`,20),t=[l];function c(o,h,d,r,u,g){return n(),s("div",null,t)}const m=a(i,[["render",c]]);export{k as __pageData,m as default};
