...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p><a href="http://tslang.cn/play/index.html" target="_blank" rel="noreferrer">http://tslang.cn/play/index.html</a></p>`,65);function b(m,v,y,q,k,f){const a=i("font");return c(),o("div",null,[d,n(a,{color:"red"},{default:p(()=>[s("<T> ")]),_:1}),s(" 表示这是一个泛型函数；"),u,n(a,{color:"red"},{default:p(()=>[s("T")]),_:1}),s(" 是一个类型参数，可以是任何类型； "),h,s(" 函数参数是"),n(a,{color:"red"},{default:p(()=>[s("T")]),_:1}),s("，返回值的类型也是"),n(a,{color:"red"},{default:p(()=>[s("T")]),_:1}),s("；传参 number 类型，那返回值的类型也是 number。 "),g])}const T=l(r,[["render",b]]);export{x as __pageData,T as default};
