...
<span class="line"><span>})</span></span></code></pre></div><h3 id="在子组件使用-van-popup-的-v-model-show-报不能修改父组件传来的show属性问题" tabindex="-1">在子组件使用 van-popup 的 v-model=&quot;show&quot; 报不能修改父组件传来的show属性问题 <a class="header-anchor" href="#在子组件使用-van-popup-的-v-model-show-报不能修改父组件传来的show属性问题" aria-label="Permalink to &quot;在子组件使用 van-popup 的 v-model=&quot;show&quot; 报不能修改父组件传来的show属性问题&quot;">​</a></h3><p><img src="`+r+`" alt="alt text"> 解决办法，定义一个新值：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;template&gt;</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,105),g=[u];function b(v,m,k,x,f,q){return n(),s("div",null,g)}const w=a(d,[["render",b]]);export{_ as __pageData,w as default};
