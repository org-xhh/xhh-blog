import{_ as s,c as n,o as a,a3 as p}from"./chunks/framework.C5U8cnJv.js";const m=JSON.parse('{"title":"前端发送网络请求","description":"","frontmatter":{},"headers":[],"relativePath":"web/js/网络请求.md","filePath":"web/js/网络请求.md"}'),e={name:"web/js/网络请求.md"},l=p(`<h1 id="前端发送网络请求" tabindex="-1">前端发送网络请求 <a class="header-anchor" href="#前端发送网络请求" aria-label="Permalink to &quot;前端发送网络请求&quot;">​</a></h1><h2 id="axios" tabindex="-1">axios <a class="header-anchor" href="#axios" aria-label="Permalink to &quot;axios&quot;">​</a></h2><p>返回 Promise 对象，支持链式调用，可以使用 .then() 和 .catch() 等方法处理响应。 ‌</p><h3 id="取消请求" tabindex="-1">取消请求 <a class="header-anchor" href="#取消请求" aria-label="Permalink to &quot;取消请求&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 第一种方式</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>})</span></span></code></pre></div><h2 id="promise" tabindex="-1">Promise <a class="header-anchor" href="#promise" aria-label="Permalink to &quot;Promise&quot;">​</a></h2><p>Promise就是为了解决回调地狱而产生的，将回调函数的嵌套，改成链式调用。</p><ul><li><p>状态</p><p>pending 进行中</p><p>fulfilled 已完成</p><p>rejected 已失败</p></li><li><p>实例方法</p><p>then()</p><p>catch()</p><p>finally()</p></li><li><p>静态方法</p><p>Promise.resolve(): 返回一个 fulfilled 状态的 Promise</p><p>Promise.reject(): 返回一个 rejected 状态的 Promise</p><p>Promise.all(): 所有Promise都成功</p><p>Promise.allSettled(): 所有Promise都完成（无论成功失败）</p><p>Promise.any(): 返回最先成功的 Promise 的结果</p><p>Promise.race(): 返回最先完成的 Promise 的结果</p></li></ul><h2 id="async-await" tabindex="-1">async/await <a class="header-anchor" href="#async-await" aria-label="Permalink to &quot;async/await&quot;">​</a></h2><p>async/await 是 ‌Promise 的语法糖‌，将异步代码以同步的形式进行编写。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const asyncReadFile = async function () {</span></span>
...
<span class="line"><span>hw.next()</span></span>
<span class="line"><span>// { value: undefined, done: true</span></span></code></pre></div>`,22),i=[l];function t(c,o,r,d,h,u){return a(),n("div",null,i)}const x=s(e,[["render",t]]);export{m as __pageData,x as default};
