import{_ as l,D as i,c as o,I as n,w as p,a as s,a3 as e,j as t,o as c}from"./chunks/framework.C5U8cnJv.js";const x=JSON.parse('{"title":"typescript 学习","description":"","frontmatter":{},"headers":[],"relativePath":"web/typescript/typescript.md","filePath":"web/typescript/typescript.md"}'),r={name:"web/typescript/typescript.md"},d=e(`<h1 id="typescript-学习" tabindex="-1">typescript 学习 <a class="header-anchor" href="#typescript-学习" aria-label="Permalink to &quot;typescript 学习&quot;">​</a></h1><p>TypeScript 是 JavaScript 的一个超集，扩展了 JavaScript 的语法。</p><p>TypeScript 是静态编译语言，在 编译期间 进行类型检查，可以在编辑器中发现大部分类型错误。</p><h2 id="基本类型" tabindex="-1">基本类型 <a class="header-anchor" href="#基本类型" aria-label="Permalink to &quot;基本类型&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>let bool: boolean = false // 布尔值</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><h2 id="任意值" tabindex="-1">任意值 <a class="header-anchor" href="#任意值" aria-label="Permalink to &quot;任意值&quot;">​</a></h2><p>任意值 any 处理不确定的数据结构，禁用类型检查，可能导致错误难以捕获，不建议使用。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>let myFavoriteNumber: any = &#39;seven&#39;;</span></span>
...
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>let a: Animal = new Animal(&#39;cat&#39;);</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>// index.ts(7,47): error TS2345: Argument of type &#39;&quot;dblclick&quot;&#39; is not assignable to parameter of type &#39;EventNames&#39;.</span></span></code></pre></div><h2 id="命名空间" tabindex="-1">命名空间 <a class="header-anchor" href="#命名空间" aria-label="Permalink to &quot;命名空间&quot;">​</a></h2><p>使用 namespace 关键字来定义一个命名空间，可以防止命名冲突。</p><p>greet.ts：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>namespace MyNamespace {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div>`,66),u=t("br",null,null,-1),h=t("br",null,null,-1),g=e(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 调用函数</span></span>
<span class="line"><span>identity&lt;number&gt;(10)</span></span>
<span class="line"><span>或</span></span>
<span class="line"><span>identity(10)</span></span></code></pre></div><p>传参 number 类型，返回值的类型也是 number。传参 string 类型，返回值的类型也是 string。</p><h4 id="泛型类" tabindex="-1">泛型类 <a class="header-anchor" href="#泛型类" aria-label="Permalink to &quot;泛型类&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>class Goods&lt;T&gt; {</span></span>
...
<span class="line"><span>    &quot;noImplicitAny&quot;: false, // 允许隐式的any，默认 false(允许)</span></span>
...
<span class="line"><span>    &quot;module&quot;: &quot;esnext&quot;, // 模块系统，可选择 commonjs、es6等</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p><a href="http://tslang.cn/play/index.html" target="_blank" rel="noreferrer">http://tslang.cn/play/index.html</a></p>`,63);function b(m,v,y,q,k,f){const a=i("font");return c(),o("div",null,[d,n(a,{color:"red"},{default:p(()=>[s("<T> ")]),_:1}),s(" 表示这是一个泛型函数；"),u,n(a,{color:"red"},{default:p(()=>[s("T")]),_:1}),s(" 是一个类型参数，可以是任何类型； "),h,s(" 函数参数是"),n(a,{color:"red"},{default:p(()=>[s("T")]),_:1}),s("，返回值的类型也是"),n(a,{color:"red"},{default:p(()=>[s("T")]),_:1}),s("。 "),g])}const T=l(r,[["render",b]]);export{x as __pageData,T as default};
