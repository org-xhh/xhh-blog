...
<span class="line"><span>  })</span></span>
<span class="line"><span>}</span></span></code></pre></div><h3 id="主进程和渲染进程" tabindex="-1">主进程和渲染进程 <a class="header-anchor" href="#主进程和渲染进程" aria-label="Permalink to &quot;主进程和渲染进程&quot;">​</a></h3><p>主进程‌：只有一个，负责生命周期管理、窗口创建、系统 API 调用（如文件读写、系统通知）</p><p>‌渲染进程‌：每个窗口对应一个独立进程，负责页面渲染和用户交互，本质是 Chromium 浏览器标签页</p><h3 id="上下文隔离" tabindex="-1">上下文隔离 <a class="header-anchor" href="#上下文隔离" aria-label="Permalink to &quot;上下文隔离&quot;">​</a></h3><p>安全封装方案，在 preload 脚本中暴露有限 API 给渲染进程</p><p>创建 preload.js 提供暴露的方法:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const {contextBridge} = require(&#39;electron&#39;)</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>})</span></span></code></pre></div><h3 id="消息对话框" tabindex="-1">消息对话框 <a class="header-anchor" href="#消息对话框" aria-label="Permalink to &quot;消息对话框&quot;">​</a></h3><p>弹出对话框</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>dialog.showMessageBox({ </span></span>
...
<span class="line"><span>})</span></span></code></pre></div><h3 id="注册全局快捷键" tabindex="-1">注册全局快捷键 <a class="header-anchor" href="#注册全局快捷键" aria-label="Permalink to &quot;注册全局快捷键&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>globalShortcut.register(&#39;ctrl + f&#39;, () =&gt; {</span></span>
...
<span class="line"><span>})</span></span></code></pre></div><h3 id="配置热更新" tabindex="-1">配置热更新 <a class="header-anchor" href="#配置热更新" aria-label="Permalink to &quot;配置热更新&quot;">​</a></h3><p>nodemon</p><h3 id="打包应用" tabindex="-1">打包应用 <a class="header-anchor" href="#打包应用" aria-label="Permalink to &quot;打包应用&quot;">​</a></h3><p><a href="https://www.electronjs.org/zh/docs/latest/tutorial/%E6%89%93%E5%8C%85%E6%95%99%E7%A8%8B" target="_blank" rel="noreferrer">Electron Forge</a></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>npm install --save-dev @electron-forge/cli</span></span>
<span class="line"><span>npx electron-forge import</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>npm run make</span></span></code></pre></div>`,74);function w(y,x,C,f,_,P){const a=e("font");return o(),l("div",null,[m,s("p",null,[t("进程通信方式："),i(a,{size:"4"},{default:c(()=>[k]),_:1})]),q])}const j=p(v,[["render",w]]);export{E as __pageData,j as default};
