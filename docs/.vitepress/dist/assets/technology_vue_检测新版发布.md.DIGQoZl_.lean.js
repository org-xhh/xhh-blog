import{_ as s,c as n,o as a,a3 as p}from"./chunks/framework.DrOZDLiO.js";const e="/assets/image.BmoZXRph.png",m=JSON.parse('{"title":"检测项目是否有新版发布","description":"","frontmatter":{},"headers":[],"relativePath":"technology/vue/检测新版发布.md","filePath":"technology/vue/检测新版发布.md","lastUpdated":1719219088000}'),l={name:"technology/vue/检测新版发布.md"},i=p(`<h1 id="检测项目是否有新版发布" tabindex="-1">检测项目是否有新版发布 <a class="header-anchor" href="#检测项目是否有新版发布" aria-label="Permalink to &quot;检测项目是否有新版发布&quot;">​</a></h1><p>在Vue项目中，判断是否发布新包通常涉及到比较项目的某个版本号与服务器上的版本号是否一致，如果不一致就刷新页面更新为最新发布的代码。</p><h2 id="vue2-检测新包" tabindex="-1">vue2 检测新包 <a class="header-anchor" href="#vue2-检测新包" aria-label="Permalink to &quot;vue2 检测新包&quot;">​</a></h2><p>package.json:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&quot;scripts&quot;: {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,16),t=[i];function o(c,r,d,u,h,v){return a(),n("div",null,t)}const f=s(l,[["render",o]]);export{m as __pageData,f as default};
