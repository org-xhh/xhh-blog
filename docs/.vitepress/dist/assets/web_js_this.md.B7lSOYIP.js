...
<span class="line"><span>    console.log(++this.count)</span></span>
<span class="line"><span>}, 1000)</span></span></code></pre></div>`,22);function b(m,_,v,k,y,f){const n=i("font");return c(),l("div",null,[u,p("p",null,[s("严格模式："),t(n,{color:"red"},{default:o(()=>[s("Uncaught TypeError: Cannot read properties of undefined (reading 'name')")]),_:1})]),g])}const q=e(d,[["render",b]]);export{T as __pageData,q as default};
