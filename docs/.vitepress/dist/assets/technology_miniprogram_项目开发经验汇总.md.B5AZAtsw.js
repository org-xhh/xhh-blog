...
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>next({ // 直接进入第二个/home，返回还是/home</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>})</span></span></code></pre></div><p>或者使用一个变量，判断开启过定时器，就return，不执行 this.player.on(&#39;play&#39;,...)里的代码。</p>`,46),c=[o];function r(h,d,u,g,m,b){return n(),s("div",null,c)}const f=a(l,[["render",r]]);export{_ as __pageData,f as default};
