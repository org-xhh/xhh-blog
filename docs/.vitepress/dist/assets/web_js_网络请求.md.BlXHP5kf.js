import{_ as s,c as n,o as a,a3 as p}from"./chunks/framework.C5U8cnJv.js";const g=JSON.parse('{"title":"前端发送网络请求","description":"","frontmatter":{},"headers":[],"relativePath":"web/js/网络请求.md","filePath":"web/js/网络请求.md","lastUpdated":null}'),e={name:"web/js/网络请求.md"},l=p(`<h1 id="前端发送网络请求" tabindex="-1">前端发送网络请求 <a class="header-anchor" href="#前端发送网络请求" aria-label="Permalink to &quot;前端发送网络请求&quot;">​</a></h1><h2 id="axios" tabindex="-1">axios <a class="header-anchor" href="#axios" aria-label="Permalink to &quot;axios&quot;">​</a></h2><h3 id="取消请求" tabindex="-1">取消请求 <a class="header-anchor" href="#取消请求" aria-label="Permalink to &quot;取消请求&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 第一种方式</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>})</span></span></code></pre></div><h2 id="promise" tabindex="-1">promise <a class="header-anchor" href="#promise" aria-label="Permalink to &quot;promise&quot;">​</a></h2><p>Promise就是为了解决回调地狱而产生的，将回调函数的嵌套，改成链式调用。</p><ul><li><p>状态</p><p>pending 进行中</p><p>fulfilled 已完成</p><p>rejected 已失败</p></li><li><p>实例方法</p><p>then()</p><p>catch()</p><p>finally</p></li><li><p>构造函数方法 Promise.all</p></li></ul><h2 id="async-await" tabindex="-1">async/await <a class="header-anchor" href="#async-await" aria-label="Permalink to &quot;async/await&quot;">​</a></h2><p>async 使用上更为简洁，将异步代码以同步的形式进行编写，是处理异步编程的最终方案。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const asyncReadFile = async function () {</span></span>
