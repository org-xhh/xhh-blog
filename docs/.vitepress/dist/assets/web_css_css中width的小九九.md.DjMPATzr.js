...
<span class="line"><span>  &lt;/body&gt;</span></span>
<span class="line"><span>&lt;/html&gt;</span></span></code></pre></div><p><img src="`+t+'" alt="alt text"></p><h3 id="三、分析" tabindex="-1">三、分析 <a class="header-anchor" href="#三、分析" aria-label="Permalink to &quot;三、分析&quot;">​</a></h3><p>1.child1：宽度默认auto，和child2一致</p><p>2.child2：设置width:auto</p><p><img src="'+l+'" alt="alt text"></p><p>最终宽度：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>500(父元素宽度) - 20(子元素margin)∗2 - 10(子元素border)∗2 - 1(子元素padding)∗2 = 438</span></span></code></pre></div><p>3.child3：设置width:100%</p><p><img src="'+i+`" alt="alt text"> 最终宽度：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>500(父元素宽度)</span></span></code></pre></div><p>4.child4：</p><p>设置width:100%; box-sizing: border-box;</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>box-sizing：border-box;</span></span>
