import{_ as a,c as s,o as n,a3 as e}from"./chunks/framework.C5U8cnJv.js";const g=JSON.parse('{"title":"Node.js中模块化方案","description":"","frontmatter":{},"headers":[],"relativePath":"nodejs/模块化方案.md","filePath":"nodejs/模块化方案.md"}'),p={name:"nodejs/模块化方案.md"},l=e(`<h1 id="node-js中模块化方案" tabindex="-1">Node.js中模块化方案 <a class="header-anchor" href="#node-js中模块化方案" aria-label="Permalink to &quot;Node.js中模块化方案&quot;">​</a></h1><p>CommonJS 和 ESM 都是JavaScript模块标准。</p><h2 id="_1-commonjs" tabindex="-1">1. CommonJS <a class="header-anchor" href="#_1-commonjs" aria-label="Permalink to &quot;1. CommonJS&quot;">​</a></h2><p>require() 导入、module.exports 导出</p><p>项目默认是 CommonJS 规范，指定文件后缀为 .cjs后，此文件会遵守CommonJS 规范。</p><h2 id="_2-es-module" tabindex="-1">2. ES Module <a class="header-anchor" href="#_2-es-module" aria-label="Permalink to &quot;2. ES Module&quot;">​</a></h2><p>（也被称为ES6 Module、ECMA Modules、ESM）</p><p>import 导入、export ( export default ) 导出</p><p>在Node.js中使用ESM，需要在package.json中设置&quot;type&quot;: &quot;module&quot;，或者文件名后缀为.mjs。</p><h2 id="区别" tabindex="-1">区别 <a class="header-anchor" href="#区别" aria-label="Permalink to &quot;区别&quot;">​</a></h2><p>ES module 是值的引用，Commonjs 是值的拷贝。</p><ul><li>‌ES module‌：导出的是值的引用。如果模块中修改了导出变量的值，那么所有导入这个变量的模块都会看到变化。这是因为 ES module(静态导入) 在<strong>编译时就确定了模块的依赖关系</strong>，并在运行时通过引用直接访问导出的值‌。</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>export let a = 10</span></span>
...
<span class="line"><span>const __dirname = dirname(fileURLToPath(import.meta.url))</span></span></code></pre></div><ul><li>import.meta： 当前模块信息的对象</li><li>fileURLToPath()：将 URL 字符串转换为对应的本地文件系统路径</li><li>dirname()：接受一个文件路径作为参数，返回该路径的目录部分</li></ul>`,31),o=[l];function t(i,c,d,r,u,m){return n(),s("div",null,o)}const b=a(p,[["render",t]]);export{g as __pageData,b as default};
