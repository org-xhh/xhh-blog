...
<span class="line"><span>})</span></span></code></pre></div>`,2),m={id:"跨级组件通信",tabindex:"-1"},T=s("a",{class:"header-anchor",href:"#跨级组件通信","aria-label":'Permalink to "<font color=red>跨级组件通信</font>"'},"​",-1),k=t(`<p>provide 用于提供可以被后代组件注入的值。</p><p>inject 注入一个由祖先组件或整个应用 (通过 app.provide()) 提供的值</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>app.provide(&#39;globalUserType&#39;, 1)</span></span>
<span class="line"><span></span></span>
<span class="line"><span>import { inject } from &#39;vue&#39;</span></span>
<span class="line"><span>let userType = ref(inject(&#39;globalUserType&#39;))</span></span></code></pre></div>`,3),x={id:"attrs",tabindex:"-1"},C=s("a",{class:"header-anchor",href:"#attrs","aria-label":'Permalink to "<font color=red>attrs</font>"'},"​",-1),S=t(`<p>包含父作用域里除 class 和 style 除外的非 props 属性集合</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { useAttrs } from &quot;vue&quot;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>const attrs = useAttrs()</span></span>
<span class="line"><span>console.log(attrs)</span></span></code></pre></div>`,2),P={id:"pinia",tabindex:"-1"},A=s("a",{class:"header-anchor",href:"#pinia","aria-label":'Permalink to "<font color=red>pinia</font>"'},"​",-1),y=t(`<p>状态管理</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { defineStore } from &#39;pinia&#39;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,3),O={id:"children-parent",tabindex:"-1"},z=s("a",{class:"header-anchor",href:"#children-parent","aria-label":'Permalink to "<font color=red>$children / $parent</font>"'},"​",-1),F={id:"provide-inject",tabindex:"-1"},G=s("a",{class:"header-anchor",href:"#provide-inject","aria-label":'Permalink to "<font color=red>provide / inject</font>"'},"​",-1),H={id:"中央事件总线-eventbus",tabindex:"-1"},K=s("a",{class:"header-anchor",href:"#中央事件总线-eventbus","aria-label":'Permalink to "<font color=red>中央事件总线 EventBus</font>"'},"​",-1),Q=t(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Vue.prototype.$bus = new Vue()</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>    &lt;/div&gt;</span></span>
<span class="line"><span>&lt;/template&gt;</span></span></code></pre></div>`,1),ps={id:"localstorage、sessionstorage-1",tabindex:"-1"},ts=s("a",{class:"header-anchor",href:"#localstorage、sessionstorage-1","aria-label":'Permalink to "<font color=red>localStorage、sessionStorage</font>"'},"​",-1);function ls(os,is,cs,rs,ds,_s){const n=o("font");return c(),i("div",null,[d,_,s("h3",h,[e(n,{color:"red"},{default:p(()=>[a("父子通信")]),_:1}),a(),u]),g,s("h3",f,[e(n,{color:"red"},{default:p(()=>[a("defineExpose")]),_:1}),a(),b]),v,s("h3",m,[e(n,{color:"red"},{default:p(()=>[a("跨级组件通信")]),_:1}),a(),T]),k,s("h3",x,[e(n,{color:"red"},{default:p(()=>[a("attrs")]),_:1}),a(),C]),S,s("h3",P,[e(n,{color:"red"},{default:p(()=>[a("pinia")]),_:1}),a(),A]),y,s("h3",q,[e(n,{color:"red"},{default:p(()=>[a("localStorage、sessionStorage")]),_:1}),a(),V]),$,s("h3",I,[e(n,{color:"red"},{default:p(()=>[a("app.config.globalProperties")]),_:1}),a(),E]),N,s("h3",R,[e(n,{color:"red"},{default:p(()=>[a("父子通信")]),_:1}),a(),D]),j,s("h3",w,[e(n,{color:"red"},{default:p(()=>[a("ref")]),_:1}),a(),B]),M,s("h3",U,[e(n,{color:"red"},{default:p(()=>[a("$attrs / $listeners")]),_:1}),a(),J]),L,s("h3",O,[e(n,{color:"red"},{default:p(()=>[a("$children / $parent")]),_:1}),a(),z]),s("h3",F,[e(n,{color:"red"},{default:p(()=>[a("provide / inject")]),_:1}),a(),G]),s("h3",H,[e(n,{color:"red"},{default:p(()=>[a("中央事件总线 EventBus")]),_:1}),a(),K]),Q,s("h3",W,[e(n,{color:"red"},{default:p(()=>[a("$root")]),_:1}),a(),X]),s("h3",Y,[e(n,{color:"red"},{default:p(()=>[a("Vuex")]),_:1}),a(),Z]),ss,s("h3",as,[e(n,{color:"red"},{default:p(()=>[a("slot")]),_:1}),a(),ns]),es,s("h3",ps,[e(n,{color:"red"},{default:p(()=>[a("localStorage、sessionStorage")]),_:1}),a(),ts])])}const gs=l(r,[["render",ls]]);export{us as __pageData,gs as default};
