...
<span class="line"><span>})</span></span></code></pre></div><h3 id="配置热更新" tabindex="-1">配置热更新 <a class="header-anchor" href="#配置热更新" aria-label="Permalink to &quot;配置热更新&quot;">​</a></h3><p>nodemon</p><p>示例：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&quot;start&quot;: &quot;nodemon --watch main.js --exec \\&quot;electron .\\&quot;&quot;,</span></span></code></pre></div><p>nodemon 监听 main.js 文件变化，然后执行命令 electron .</p><h3 id="打包应用" tabindex="-1">打包应用 <a class="header-anchor" href="#打包应用" aria-label="Permalink to &quot;打包应用&quot;">​</a></h3><p><a href="https://www.electronjs.org/zh/docs/latest/tutorial/%E6%89%93%E5%8C%85%E6%95%99%E7%A8%8B" target="_blank" rel="noreferrer">Electron Forge</a></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>npm install --save-dev @electron-forge/cli</span></span>
<span class="line"><span>npx electron-forge import</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>npm run make</span></span></code></pre></div>`,76);function w(x,y,C,f,_,P){const a=e("font");return o(),l("div",null,[m,s("p",null,[t("进程通信方式："),i(a,{size:"4"},{default:c(()=>[k]),_:1})]),q])}const E=p(v,[["render",w]]);export{M as __pageData,E as default};
