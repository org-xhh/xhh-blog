...
<span class="line"><span>&lt;/div&gt;</span></span></code></pre></div><h2 id="使用-scss" tabindex="-1">使用 scss <a class="header-anchor" href="#使用-scss" aria-label="Permalink to &quot;使用 scss&quot;">​</a></h2><p>create-react-app 内置了 scss 预处理器，只需要安装</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>npm i sass -D</span></span></code></pre></div><h2 id="css-modules" tabindex="-1">CSS Modules <a class="header-anchor" href="#css-modules" aria-label="Permalink to &quot;CSS Modules&quot;">​</a></h2><p>create-react-app 内置了对 CSS Modules 的支持。</p><p>‌1.更改文件名 ‌</p><p>将 CSS 文件名从 styles.css 更改为 styles.module.css</p><p>2.引入样式 ‌</p><p>在组件文件中，使用 ES6 模块语法引入样式文件</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import styles from &#39;./styles.module.css&#39;;</span></span></code></pre></div><p>‌3.使用样式 ‌</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;div className={styles.myClass}&gt;</span></span></code></pre></div><h2 id="状态管理-redux" tabindex="-1">状态管理 Redux <a class="header-anchor" href="#状态管理-redux" aria-label="Permalink to &quot;状态管理 Redux&quot;">​</a></h2><h4 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-label="Permalink to &quot;安装&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>npm install @reduxjs/toolkit react-redux -S</span></span></code></pre></div><h4 id="为-react-提供-redux-store" tabindex="-1">为 React 提供 Redux Store <a class="header-anchor" href="#为-react-提供-redux-store" aria-label="Permalink to &quot;为 React 提供 Redux Store&quot;">​</a></h4><p>index.js:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import store from &#39;./store/index.js&#39;</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>// 获取</span></span>
<span class="line"><span>process.env.REACT_APP_ENV // release</span></span></code></pre></div><h4 id="第二种方式-使用-dotenv" tabindex="-1">第二种方式：使用 dotenv <a class="header-anchor" href="#第二种方式-使用-dotenv" aria-label="Permalink to &quot;第二种方式：使用 dotenv&quot;">​</a></h4><p>安装</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>npm install dotenv-cli -D</span></span></code></pre></div><p>自定义环境变量名</p><p><img src="`+t+`" alt="alt text"></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 配置</span></span>
...
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>export default Button;</span></span></code></pre></div><h2 id="react-hooks" tabindex="-1">React Hooks <a class="header-anchor" href="#react-hooks" aria-label="Permalink to &quot;React Hooks&quot;">​</a></h2><p>使函数式组件能够拥有类组件的一些特性，例如状态管理和生命周期方法的使用。</p><h4 id="usestate" tabindex="-1">useState <a class="header-anchor" href="#usestate" aria-label="Permalink to &quot;useState&quot;">​</a></h4><p>向组件添加状态变量</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const [count, setCount] = useState(0);</span></span></code></pre></div><h4 id="useeffect" tabindex="-1">useEffect <a class="header-anchor" href="#useeffect" aria-label="Permalink to &quot;useEffect&quot;">​</a></h4><p>用于执行副作用操作，比如数据获取、订阅或手动更改 DOM，它与类组件中的 componentDidMount、componentDidUpdate 和 componentWillUnmount 生命周期类似。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>useEffect(() =&gt; {</span></span>
...
<span class="line"><span>  };</span></span>
<span class="line"><span>}, [serverUrl, roomId]);</span></span></code></pre></div><h4 id="useref" tabindex="-1">useRef <a class="header-anchor" href="#useref" aria-label="Permalink to &quot;useRef&quot;">​</a></h4><p>引用一个不需要渲染的值。</p><p>使用：使用 ref 引用一个值；通过 ref 操作 DOM。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const divRef = useRef(null);</span></span>
...
<span class="line"><span>    &lt;/div&gt;</span></span></code></pre></div><h4 id="useimperativehandle" tabindex="-1">useImperativeHandle <a class="header-anchor" href="#useimperativehandle" aria-label="Permalink to &quot;useImperativeHandle&quot;">​</a></h4><p>用于使用 ref 时暴露 DOM 元素的方法。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const compRef = useRef&lt;HTMLInputElement&gt;(null);</span></span>
...
<span class="line"><span>    // 下方代码不起作用，因为 DOM 节点(compRef.current)并未被暴露出来：</span></span>
<span class="line"><span>    // compRef.current.style.opacity = 0.5;</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span>&lt;form style={{ marginTop: &#39;50px&#39; }}&gt;</span></span>
<span class="line"><span>  &lt;MyInput placeholder=&#39;please input&#39; ref={compRef} /&gt;</span></span>
<span class="line"><span>  &lt;button type=&quot;button&quot; onClick={buttonClick}  style={{ border: &#39;1px solid #888&#39;,marginLeft: &#39;5px&#39;,padding: &#39;2px 5px&#39; }}&gt;</span></span>
<span class="line"><span>    Edit</span></span>
<span class="line"><span>  &lt;/button&gt;</span></span>
<span class="line"><span>&lt;/form&gt;</span></span></code></pre></div><p>myInput.js</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { forwardRef, useRef, useImperativeHandle } from &#39;react&#39;;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// 使用forwardRef：自定义组件才会暴露它们内部 DOM 节点的 ref。</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>  // 使用 ref 时暴露 DOM 元素的方法</span></span>
...
<span class="line"><span>  }, []);</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  return (&lt;input {...props} ref={inputRef} style={{ background: &#39;#999&#39;, paddingLeft: &#39;5px&#39; }} /&gt;)</span></span>
<span class="line"><span>});</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>    &lt;/&gt;</span></span>
<span class="line"><span>  )}</span></span></code></pre></div><h4 id="usememo" tabindex="-1">useMemo <a class="header-anchor" href="#usememo" aria-label="Permalink to &quot;useMemo&quot;">​</a></h4><p>用于缓存计算结果，避免在每次渲染时重复计算‌。（类似于Vue中的computed属性）</p><h4 id="usecallback" tabindex="-1">useCallback <a class="header-anchor" href="#usecallback" aria-label="Permalink to &quot;useCallback&quot;">​</a></h4><p>用于记忆化回调函数，避免在每次渲染时重新创建函数‌。</p><h4 id="usetransition" tabindex="-1">useTransition <a class="header-anchor" href="#usetransition" aria-label="Permalink to &quot;useTransition&quot;">​</a></h4><p>useTransition 是在不阻塞 UI 的情况下更新状态的 React Hook。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const [isPending, startTransition] = useTransition()</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>});</span></span></code></pre></div><p><img src="`+l+'" alt="alt text"><img src="'+i+`" alt="alt text"></p><h4 id="usedeferredvalue" tabindex="-1">useDeferredValue <a class="header-anchor" href="#usedeferredvalue" aria-label="Permalink to &quot;useDeferredValue&quot;">​</a></h4><p>延迟更新 UI 的某些部分。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const deferredValue = useDeferredValue(value)</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>将文件重命名为 .tsx 或 .ts 文件</p><hr><p>gitee 源码：</p><p><a href="https://gitee.com/org-xhh/react-project" target="_blank" rel="noreferrer">https://gitee.com/org-xhh/react-project</a></p>`,143),r=[o];function d(u,h,g,m,b,v){return n(),a("div",null,r)}const f=s(c,[["render",d]]);export{k as __pageData,f as default};
