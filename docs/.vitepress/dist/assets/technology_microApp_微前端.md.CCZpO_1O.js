...
<span class="line"><span>  // prefetch: [&#39;vue-project&#39;],</span></span>
...
<span class="line"><span>}</span></span>
<span class="line"><span>export default EmptyPage</span></span></code></pre></div><h3 id="vite-构建的子应用-vue、-react" tabindex="-1">vite 构建的子应用(vue、 react) <a class="header-anchor" href="#vite-构建的子应用-vue、-react" aria-label="Permalink to &quot;vite 构建的子应用(vue、 react)&quot;">​</a></h3><p>qiankun 不支持 vite，需要使用插件 vite-plugin-qiankun</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>npm i vite-plugin-qiankun -S</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import qiankun from &#39;vite-plugin-qiankun&#39;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>  },</span></span>
<span class="line"><span>  ...</span></span>
<span class="line"><span>})</span></span></code></pre></div><h3 id="vue-vite-子应用路由" tabindex="-1">vue+vite 子应用路由 <a class="header-anchor" href="#vue-vite-子应用路由" aria-label="Permalink to &quot;vue+vite 子应用路由&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { qiankunWindow } from &#39;vite-plugin-qiankun/dist/helper&#39;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>    ...</span></span>
<span class="line"><span>})</span></span></code></pre></div><h3 id="react-vite-子应用路由" tabindex="-1">react+vite 子应用路由 <a class="header-anchor" href="#react-vite-子应用路由" aria-label="Permalink to &quot;react+vite 子应用路由&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { qiankunWindow } from &#39;vite-plugin-qiankun/dist/helper&#39;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>], { basename: qiankunWindow.__POWERED_BY_QIANKUN__ ? &#39;/react-project&#39; : &#39;/&#39; }) // 路由前缀</span></span></code></pre></div><h3 id="vue-vite-子应用-main-js-添加生命周期" tabindex="-1">vue+vite 子应用 main.js 添加生命周期 <a class="header-anchor" href="#vue-vite-子应用-main-js-添加生命周期" aria-label="Permalink to &quot;vue+vite 子应用 main.js 添加生命周期&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { renderWithQiankun, qiankunWindow } from &#39;vite-plugin-qiankun/dist/helper&#39;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>})</span></span></code></pre></div><h3 id="react-vite-子应用-main-tsx-添加生命周期" tabindex="-1">react+vite 子应用 main.tsx 添加生命周期 <a class="header-anchor" href="#react-vite-子应用-main-tsx-添加生命周期" aria-label="Permalink to &quot;react+vite 子应用 main.tsx 添加生命周期&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { renderWithQiankun, qiankunWindow } from &#39;vite-plugin-qiankun/dist/helper&#39;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h3 id="webpack-子应用配置" tabindex="-1">webpack 子应用配置 <a class="header-anchor" href="#webpack-子应用配置" aria-label="Permalink to &quot;webpack 子应用配置&quot;">​</a></h3><p>.env文件：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>BROWSER=none</span></span>
<span class="line"><span>PORT=8104</span></span></code></pre></div><p>路由前缀：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const router = createBrowserRouter([</span></span>
<span class="line"><span>  {</span></span>
<span class="line"><span>    path: &#39;/&#39;,</span></span>
...
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>&lt;CommonComp /&gt;</span></span></code></pre></div><h3 id="主子应用通信" tabindex="-1">主子应用通信 <a class="header-anchor" href="#主子应用通信" aria-label="Permalink to &quot;主子应用通信&quot;">​</a></h3><h4 id="主应用" tabindex="-1">主应用 <a class="header-anchor" href="#主应用" aria-label="Permalink to &quot;主应用&quot;">​</a></h4><p>initGlobalState设置全局状态：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { initGlobalState, MicroAppStateActions } from &#39;qiankun&#39;</span></span>
<span class="line"><span>   </span></span>
